...
const SalariedProfessionalGame: React.FC<SalariedProfessionalGameProps> = ({ onComplete, onBack }) => {
  const [gameState, setGameState] = useState<GameState>({
    ...
    salary: 4200, // Starting $4,200 monthly
    ...
    1: [ // Financial Awareness & Identity
      {
        ...
        description: 'Month 1: You just received your first $4,200 salary. It\'s a huge moment!',
        situation: 'Your bank account shows $4,200. Your friends want to celebrate with an expensive party ($400). Your family expects you to contribute $300 home. You need to make your first major financial decision.',
        visualIcon: Wallet,
        choices: [
          {
            id: 'party_path',
            ...
            consequences: { expenses: 400, happiness: 15, knowledge: -5, confidence: -10, financialFreedomScore: -5 },
          ...
          {
            id: 'balanced_path',
            text: 'Suggest a modest celebration ($100) + save the rest',
            pathName: 'The Balanced Path',
            consequences: { expenses: 100, savings: 500, happiness: 8, knowledge: 10, confidence: 15, financialFreedomScore: 10 },
            feedback: 'Excellent choice! You\'re learning to balance enjoyment with financial responsibility.',
            futureOutcome: 'In 6 months: You\'ll have $3,000 saved while still enjoying life responsibly.',
          ...
          },
          {
            ...
            consequences: { savings: 1200, happiness: -10, knowledge: 5, confidence: 5, financialFreedomScore: 5 },
      ...
      },
      {
        ...
        situation: 'Your colleague earns the same salary but seems financially smarter. They mention index funds, CDs, and credit scores. You feel overwhelmed but curious.',
        visualIcon: BookOpen,
        choices: [
          {
            id: 'learn_path',
  ...
  const calculateFinancialFreedom = () => {
    const savingsScore = Math.min(30, (gameState.savings / 125000) * 30);
    const knowledgeScore = (gameState.knowledge / 100) * 25;
    const confidenceScore = (gameState.confidence / 100) * 20;
    const investmentScore = Math.min(15, (gameState.investments / 50000) * 15);
    const emergencyScore = Math.min(10, (gameState.emergencyFund / 25000) * 10);
