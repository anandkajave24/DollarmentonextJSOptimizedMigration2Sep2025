...
const wordDefinitions: { [key: string]: string } = {
  ...
  'investment': 'Systematic Investment Plan - a method of investing in index funds regularly',
...
const wordSearchBatches = [
  ...
  {
    id: 5,
    words: ['TAX', 'PPF', 'EPF', 'investment', 'EMI', 'KYC', 'PAN', 'GST', 'TDS', 'ITR'],
  }
];
...
export default function FinancialWordSearch() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SEO 
        title="Financial Word Search | DollarMento"
        ...
        canonical="https://dollarmento.com/financial-word-search"
        ogType="website"
      />
