...
export default function Goals() {
  return (
    <>
      <SEO 
        title="Financial Goals - Set, Track & Achieve Your Money Goals"
        description="Set and track your financial goals with our comprehensive goal management system. Create savings goals, investment targets, and monitor progress with detailed analytics and milestone tracking."
        keywords="financial goals, savings goals, goal tracking, financial planning, goal achievement, money goals, investment goals, financial targets, goal management"
        canonical="https://dollarmento.com/goals"
      />
