...
export default function Guide() {
  ...
  return (
    <div className="px-4 py-6">
      ...
      {selectedArticle ? (
        <ArticleView article={selectedArticle} onBack={() => setSelectedArticle(null)} setSelectedArticle={setSelectedArticle} />
      ) : (
        <>
          {/* Search Bar */}
          <div className="mb-6">
...
function ArticleView({ article, onBack, setSelectedArticle }: { article: GuideArticle; onBack: () => void; setSelectedArticle: (article: GuideArticle | null) => void }) {
  return (
    <div>
            ...
            .map(relatedArticle => (
              <Card 
                ...
                onClick={() => { 
                  window.scrollTo(0, 0);
                  onBack();
                  setTimeout(() => setSelectedArticle(relatedArticle), 10);
                }}
              >
                <CardContent className="p-4">
...
const articles: GuideArticle[] = [
  {
    id: 1,
    title: "Getting Started with investments: A Beginner's Guide",
    summary: "Learn the basics of Systematic Investment Plans and how they can help build long-term wealth",
    content: `
      <h2>What is a Systematic Investment Plan (investment)?</h2>
      <p>A Systematic Investment Plan (investment) is an investment strategy offered by index funds that allows you to invest a fixed amount at regular intervals (typically monthly) instead of making lump-sum investments. It's similar to a recurring deposit, but the money goes into market-linked index funds instead of a fixed-interest account.</p>
      
      <h2>How Does a investment Work?</h2>
      <p>When you set up a investment, a fixed amount is automatically debited from your bank account and invested in a mutual fund of your choice. The process involves:</p>
      <ol>
      ...
      <h2>Benefits of Investing Through investments</h2>
      <ul>
        ...
        <li><strong>Financial Discipline:</strong> investments instill a habit of regular investing, promoting financial discipline.</li>
        ...
        <li><strong>Flexibility:</strong> Most investments offer flexibility to increase, decrease, pause, or stop your investments without penalties.</li>
      </ul>
      ...
      <ol>
        ...
        <li><strong>Assess Your Risk Tolerance:</strong> Different index funds carry different levels of risk. Understand how much volatility you can tolerate.</li>
        <li><strong>Choose the Right Mutual Fund:</strong> Based on your goals and risk tolerance, select appropriate index funds. Equity funds are suitable for long-term goals, while debt funds may be better for shorter-term objectives.</li>
        <li><strong>Decide on the investment Amount:</strong> Calculate how much you can comfortably invest monthly. Even small amounts can grow significantly over time.</li>
        ...
        <li><strong>Set Up Auto-Debit:</strong> Arrange for the automatic deduction of your investment amount from your bank account on the specified date.</li>
      </ol>
      
      <h2>Common investment Mistakes to Avoid</h2>
      <ul>
        <li><strong>Timing the Market:</strong> investments are designed to work over time. Don't try to time your investments based on market conditions.</li>
        <li><strong>Stopping investments During Market Downturns:</strong> Market downturns are actually opportunities to buy more units at lower prices.</li>
      ...
      <h2>investment Calculators and Tools</h2>
      <p>To understand how your investments might grow over time, use our <a href="/sip-calculator">investment Calculator</a>. It helps estimate the future value of your investments based on your monthly contribution, expected rate of return, and investment duration.</p>
    `,
    category: "investing",
    tags: ["Mutual Funds", "investment", "Beginner", "Long-term Investment"],
    readTime: 8,
    level: "beginner",
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li><strong>Liquid index funds:</strong> Potentially higher returns with the ability to withdraw funds in 1-2 business days</li>
      </ul>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li>Lower maintenance charges compared to index funds</li>
      </ul>
      ...
      <ul>
        <li><strong>Section 80CCD(1):</strong> Deduction for self-contribution up to 10% of salary (for salaried) or 20% of gross income (for self-employed), subject to the overall limit of $1.5 thousand under Section 80C</li>
        <li><strong>Section 80CCD(1B):</strong> Additional deduction of up to $50,000 for NPS contributions, over and above the $1.5 thousand limit under Section 80C</li>
      ...
      <ul>
        ...
        <li>If the total corpus is $5 thousand or less, you can withdraw the entire amount</li>
      </ul>
      ...
      <ul>
        ...
        <li>If the total corpus is $2.5 thousand or less, you can withdraw the entire amount</li>
      </ul>
      ...
      <table>
        ...
        <tr>
          ...
          <td>$2 thousand+ (80C + 80CCD(1B) + employer contribution)</td>
          <td>$1.5 thousand (under 80C)</td>
          <td>Employee contribution up to $1.5 thousand (under 80C)</td>
          <td>$1.5 thousand (under 80C)</td>
        </tr>
        <tr>
          <td>Return Type</td>
      ...
      <ul>
        <li>Individuals looking for additional tax benefits beyond $1.5 thousand under Section 80C</li>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li><strong>Recommendation:</strong> In metro cities, a minimum coverage of $5-10 thousands per person is advisable</li>
...
const faqItems: FAQItem[] = [
  {
    ...
    answer: "Saving means putting money aside, typically in a bank account, for short-term goals and emergencies. It's low-risk but offers minimal returns. Investing means using your money to buy assets like stocks, index funds, or real estate that have the potential to grow in value over time. It involves higher risk but offers the potential for higher returns, especially over longer periods.",
    category: "general"
  },
  {
  ...
  },
  {
    ...
    answer: "Historically, equity investments (stocks or equity index funds) have provided the highest returns over long periods (10+ years). For most investors, a diversified portfolio of equity index funds, potentially including index funds, is the most accessible way to build long-term wealth. However, the 'best' investment also depends on your risk tolerance, time horizon, and financial goals.",
    category: "investments"
  },
  {
  ...
  {
    question: "Can I save taxes by investing in index funds?",
    answer: "Yes, investments in Equity Linked Saving Schemes (ELSS) index funds qualify for tax deduction under Section 80C of the Income Tax Act, up to $1.5 thousand per financial year. ELSS funds have a lock-in period of 3 years, which is the shortest among all tax-saving investments under Section 80C. Additionally, long-term capital gains from equity index funds (held for more than 1 year) up to $1 thousand per year are tax-free.",
    category: "taxes"
  },
  {
    question: "How much do I need to save for retirement?",
    answer: "The amount needed for retirement varies based on your desired lifestyle, expected lifespan, inflation, and other factors. A common guideline is to accumulate a corpus that can generate 70-80% of your pre-retirement income. For example, if you need $50,000 monthly in today's value at retirement, and assuming a 7% return and 5% inflation, you might need approximately $1.5-2 million for a 25-year retirement. Use our retirement calculator for a personalized estimate.",
    category: "retirement"
  },
  {
