...
export default function Insights() {
  return (
    <>
      <SEO 
        title="Portfolio Insights - Investment Analytics & Performance Dashboard"
        description="Get comprehensive insights into your portfolio performance with advanced analytics, market trends, and personalized recommendations. Track your investment performance and optimize your portfolio."
        keywords="portfolio insights, investment analytics, portfolio performance, investment dashboard, market analysis, portfolio tracking, investment metrics, financial analytics"
        canonical="https://dollarmento.com/insights"
      />
        ...
        <CardContent className="p-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-medium">Increase investment Amounts</h4>
                <p className="text-sm text-[#757575] mt-1">You're on track to meet your goals. Consider increasing your investment amounts to reach them faster.</p>
                <button className="mt-2 text-xs bg-primary text-white px-3 py-1 rounded-full">Take Action</button>
              </div>
            </div>
          </div>
