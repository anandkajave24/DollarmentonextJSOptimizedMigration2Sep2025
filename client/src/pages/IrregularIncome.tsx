...
export default function IrregularIncome() {
  return (
    <>
      <SEO 
        title="Irregular Income Manager - Budgeting for Freelancers & Variable Income"
        description="Specialized budgeting tool for irregular and variable income. Perfect for freelancers, contractors, and seasonal workers to manage finances with unpredictable income streams."
        keywords="irregular income budgeting, freelancer budget, variable income management, contractor finances, seasonal income planning, gig economy budgeting, income variability, freelancer financial planning"
        canonical="https://dollarmento.com/irregular-income"
      />
      <IrregularIncomeContent />
    </>
  );
}

function IrregularIncomeContent() {
    ...
    <div className="px-4 py-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          ...
          <h2 className="text-lg font-medium text-amber-600">Irregular Income</h2>
        </div>
      </div>
      
      <div className="mb-6 px-4">
        <p className="text-muted-foreground">
          Specialized budgeting tools for American freelancers, contractors, and gig workers with fluctuating income. Plan around irregular income streams with emergency fund strategies and seasonal expense management.
        </p>
      </div>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <Badge variant={totalGuaranteedMonthlyIncome >= essentialMonthlyExpenses ? "default" : "destructive"}>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Badge variant={incomeSources.length > 2 ? "default" : "outline"}>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Badge variant={totalExpectedMonthlyIncome > totalMonthlyExpenses * 1.2 ? "default" : "outline"}>
                  ...
                  <DialogContent className="sm:max-w-[500px]">
                    ...
                    <div className="grid gap-4 py-4">
                      <div className="grid gap-2">
                        ...
                        <Input 
                          id="expense-name" 
                          placeholder="e.g., Rent/Mortgage, Utilities, Groceries" 
