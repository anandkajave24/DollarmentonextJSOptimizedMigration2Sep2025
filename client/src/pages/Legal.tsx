...
export default function Legal() {
  ...
  useEffect(() => {
    // Check for tab in URK query parameters
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Legal Documents | DollarMento</title>
      </Helmet>
      ...
      <div className="container max-w-4xl mx-auto px-4 py-8 pt-20">
        ...
        <p className="text-gray-600 mb-8">
          Please read these documents carefully. They govern your use of DollarMento and provide
            ...
            <CardContent className="p-6">
              <TabsContent value="terms" className="mt-0">
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p>
                    By accessing and using DollarMento ("the App"), you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use the App.
                  </p>
                  
                  <h2 className="text-lg font-semibold mt-6">2. Description of Service</h2>
                  <p>
                    DollarMento is a financial education platform that provides American users with tools, resources, and information to improve their financial literacy and manage their finances. The App offers features such as goal setting, budget tracking, financial education, and portfolio management.
                  </p>
                  ...
                  <p>
                    All content, features, and functionality of the App, including but not limited to text, graphics, logos, icons, images, audio clips, digital downloads, and software, are the exclusive property of DollarMento and are protected by copyright, trademark, and other intellectual property laws.
                  </p>
                  ...
                  <p>
                    In no event shall DollarMento be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or related to your use of the App.
                  </p>
                  ...
                  <p>
                    If you have any questions or concerns about these Terms, please contact us at support@dollarmento.com.
                  </p>
                </div>
              </TabsContent>
              ...
              <TabsContent value="privacy" className="mt-0">
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p>
                    At DollarMento, we respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our App. Please read this Privacy Policy carefully.
                  </p>
                  ...
                  <p>
                    If you have any questions or concerns about this Privacy Policy, please contact us at privacy@dollarmento.com.
                  </p>
                </div>
              </TabsContent>
              ...
              <TabsContent value="disclaimer" className="mt-0">
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <h2 className="text-lg font-semibold mt-6">9. Insurance Calculator Disclaimer</h2>
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
                    <p>
                      <strong>Educational Tool Only:</strong> This calculator provides estimates for educational and planning purposes only. 
                      These are not actual premium quotes or policy offers.
                    </p>
                    <p>
                      <strong>Professional Consultation Required:</strong> Please consult with a certified insurance advisor or licensed 
                      insurance agent for personalized recommendations, actual premium quotes, and policy details.
                    </p>
                    <p>
                      <strong>Health Assessment:</strong> Actual premiums depend on detailed medical underwriting, including medical 
                      examinations, blood tests, and health history verification that this calculator cannot assess.
                    </p>
                    <p>
                      <strong>Policy Terms:</strong> Coverage terms, exclusions, waiting periods, and claim procedures vary significantly 
                      between insurance companies and specific policy products.
                    </p>
                    <p>
                      <strong>No Guarantee:</strong> DollarMento does not guarantee the availability, pricing, or terms of any insurance 
                      products mentioned in this calculator.
                    </p>
                    <p>
                      <strong>State Regulations:</strong> Insurance regulations and available products vary by state. Ensure any insurance 
                      product you consider is available and regulated in your state of residence.
                    </p>
                    <p>
                      <strong>Regular Updates:</strong> Insurance market conditions, regulations, and company offerings change frequently. 
                      Always verify current information with insurance providers or licensed agents.
                    </p>
                  </div>

                  <h2 className="text-lg font-semibold mt-6">10. Limitation of Liability</h2>
                  <p>
                  ...
                  <h2 className="text-lg font-semibold mt-6">11. Changes to This Disclaimer</h2>
                  <p>
                  ...
                  <p>
                    If you have any questions or concerns about this Disclaimer, please contact us at legal@dollarmento.com.
                  </p>
                </div>
              </TabsContent>
            </CardContent>
