...
const InsuranceBuyingChecklist: React.FC<InsuranceBuyingChecklistProps> = ({ onConfidenceChange, insuranceType = "term" }) => {
  ...
  const typeSpecificChecklists: Record<string, { policy: ChecklistItem[], riders: ChecklistItem[], medical?: ChecklistItem[] }> = {
    ...
    "internationaltravel": {
      policy: [
        { id: "medicalCoverage", text: "Medical coverage minimum $100,000 ($80 thousands)", required: true },
    ...
    "domestictravel": {
      policy: [
        { id: "medicalCoverage", text: "Medical expenses coverage (min $2 thousands)", required: true },
    ...
    "studenttravel": {
      policy: [
        { id: "medicalCoverage", text: "Medical coverage minimum $250,000 ($2 millions)", required: true },
    ...
    "seniortravel": {
      policy: [
        ...
        { id: "medicalCoverage", text: "Higher medical coverage (min $150,000/$1.2 million)", required: true },
    ...
    "health": {
      policy: [
        { id: "coverage", text: "Coverage = at least $10K per person", required: true },
    ...
    "family": {
      policy: [
        { id: "coverage", text: "Coverage = at least $20K for whole family", required: true },
