      ...
      <div className="relative">
        ...
        >
          <svg viewBox="0 0 200 280" className="w-full h-full">
            ...
            {/* Nose */}
            <path d="M 100 50 L 98 55 L 102 55 Z" fill="#E6A477" />
            ...
            {wealth === 'wealthy' && (
              ...
              >
                ...
                {/* Tie */}
                <path d="M 98 90 L 102 90 L 105 120 L 95 120 Z" fill="#8B0000" />
                {/* Briefcase */}
            ...
            {wealth === 'rich' && (
              ...
              >
                ...
                {/* Simple tie */}
                <path d="M 99 90 L 101 90 L 103 115 L 97 115 Z" fill="#4169E1" />
              </motion.g>
            )}
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            <div className="text-center mb-8">
              ...
              <div className="text-2xl font-bold text-green-600">
                Final Net Worth: ₹{(gameState.netWorth / 100000).toFixed(1)} Lakhs
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <div className="text-lg font-bold text-green-600">₹{(gameState.netWorth/100000).toFixed(1)}L</div>
            </div>
          </div>
