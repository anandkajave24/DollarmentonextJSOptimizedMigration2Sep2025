  ...
  const scenarios = [
    ...
    },
    {
      ...
      choices: [
        {
          id: 'six_months',
          text: '6 months expenses (₹3 lakhs) - enough to handle most emergencies',
        ...
        {
          id: 'three_months',
          text: '3 months expenses (₹1.5 lakhs) - should be sufficient for most situations',
        ...
        {
          id: 'twelve_months',
          text: '12 months expenses (₹6 lakhs) - maximum security against any situation',
    ...
    },
    {
      ...
      choices: [
        {
          id: 'wealth_building',
          text: 'Build a diversified investment portfolio worth ₹25+ lakhs through systematic investing',
