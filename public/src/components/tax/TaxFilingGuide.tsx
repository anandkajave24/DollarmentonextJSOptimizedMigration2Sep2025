                    ...
                    {userType === 'business' && (
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                          ...
                          <li className="ml-8">- If turnover ≤ ₹2 crore (soon ₹3 crore with {'>'}95% digital)</li>
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent className="w-80 p-3">
                            ...
                            <p className="mt-2 text-sm text-blue-600 font-medium">Where to get it: Apply online through NSDL (https://www.onlineservices.nsdl.com) or UTITSL portals. You can also download e-PAN instantly through the income tax portal.</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </li>
                      ...
                      <li className="flex items-start">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent className="w-80 p-3">
                              <p>AIS is a comprehensive statement displaying all financial transactions reported to the Income Tax Department from various sources, including banks, mutual funds, employers, and other entities. It shows high-value transactions, interest income, dividends, and more, helping ensure complete income reporting.</p>
                ...
                <div>
                  <h3 className="font-medium mb-3 text-amber-700 flex items-center">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="w-80 p-3">
                          <p>The Old Tax Regime allows you to claim various deductions and exemptions such as Section 80C (up to ₹1.5 lakh), Section 80D (medical insurance), HRA, home loan interest, and more. This may be beneficial if you have significant eligible deductions.</p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </h3>
                  <div className="overflow-x-auto">
                    <table className="min-w-full bg-white border border-gray-200">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        <tr>
                          <td className="px-4 py-2 text-sm">0 - 2.5 lakh</td>
                          <td className="px-4 py-2 text-sm">Nil</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">2.5 - 5 lakh</td>
                          <td className="px-4 py-2 text-sm">5%</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">5 - 7.5 lakh</td>
                          <td className="px-4 py-2 text-sm">20%</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">7.5 - 10 lakh</td>
                          <td className="px-4 py-2 text-sm">20%</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">10 - 12.5 lakh</td>
                          <td className="px-4 py-2 text-sm">30%</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">12.5 - 15 lakh</td>
                          <td className="px-4 py-2 text-sm">30%</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">Above 15 lakh</td>
                          <td className="px-4 py-2 text-sm">30%</td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-2 text-sm text-gray-700">
                      ...
                      <li>Home Loan Interest: Up to ₹2 lakh</li>
                ...
                <div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full bg-white border border-gray-200">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        <tr>
                          <td className="px-4 py-2 text-sm">0 - 3 lakh</td>
                          <td className="px-4 py-2 text-sm">Nil</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">3 - 5 lakh</td>
                          <td className="px-4 py-2 text-sm">5%</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">6 - 9 lakh</td>
                          <td className="px-4 py-2 text-sm">10%</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">9 - 12 lakh</td>
                          <td className="px-4 py-2 text-sm">15%</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">12 - 15 lakh</td>
                          <td className="px-4 py-2 text-sm">20%</td>
                        </tr>
                        <tr>
                          <td className="px-4 py-2 text-sm">Above 15 lakh</td>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-2 text-sm text-gray-700">
                      ...
                      <li>Have income below ₹7 lakh</li>
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="faq1">
              ...
              <AccordionContent className="px-6 py-4">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4 mt-2">
                  <li>Your total income exceeds ₹2.5 lakh (₹3 lakh for senior citizens)</li>
            ...
            <AccordionItem value="faq3">
              ...
              <AccordionContent className="px-6 py-4">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong>Section 44AD:</strong> For small businesses with turnover up to ₹2 crore (₹3 crore if {'>'}&nbsp;95% digital). Declare 8% of turnover (or 6% for digital transactions) as taxable income without maintaining detailed books.</li>
                  <li><strong>Section 44ADA:</strong> For professionals with gross receipts up to ₹50 lakh. Declare 50% of receipts as income without maintaining detailed expense records.</li>
                </ul>
            ...
            <AccordionItem value="faq8">
              ...
              <AccordionContent className="px-6 py-4">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>NSDL TIN website using your PAN</li>
