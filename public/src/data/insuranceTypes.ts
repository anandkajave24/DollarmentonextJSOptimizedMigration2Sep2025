...
export const termLifeInsurance: InsuranceDetail = {
  ...
  features: [
    "High Sum Assured: Up to ₹5 Cr or more at just ₹500-600/month for a 30-year-old",
  ...
  keyPoints: [
    { 
      ...
      content: "Provides comprehensive financial protection for dependents. Experts recommend coverage of 15-20x annual income (₹75 lakh-2 crore for middle-income families), ensuring 60-70% income replacement for 15-20 years, with premiums as low as ₹9,000-15,000 annually for a 30-year-old non-smoker securing ₹1 crore coverage.",
      importance: "Critical",
      icon: "👨‍👩‍👧"
    },
    { 
      title: "Liability Clearance", 
      content: "Prevents debt burden transfer to family members. With average urban household debt of ₹32 lakhs in home loans, ₹5-7 lakhs in vehicle loans, and ₹3-5 lakhs in personal loans, term insurance guarantees immediate debt clearance, preventing 65-75% of families from asset liquidation or financial distress.",
      importance: "Important",
      icon: "🏛️"
    },
    { 
      title: "Pure Protection Value", 
      content: "Maximizes coverage at minimal cost compared to alternatives. Term insurance offers ₹1 crore coverage at ₹9,000-15,000 annually versus ₹90,000-1.2 lakh for traditional policies, providing 8-10x more protection per premium rupee with rates fixed for 30+ years despite medical inflation of 15-18% annually.",
      importance: "Recommended",
      icon: "💰"
    },
    { 
      title: "Future Goal Protection", 
      content: "Secures long-term family financial obligations. With higher education costs increasing from ₹8-10 lakhs to ₹25-30 lakhs over 10 years and retirement corpus requirements of ₹1-1.5 crore (inflation-adjusted), term insurance ensures these goals remain achievable even in policyholder's absence.",
      importance: "Advisable",
      icon: "🎯"
    }
  ],
  taxBenefits: [
    { section: "80C", benefit: "Premiums up to ₹1.5L/year deductible from taxable income, saving up to ₹46,800 annually for those in the 30% tax bracket" },
    { section: "10(10D)", benefit: "Death benefit 100% tax-free for the nominee regardless of amount (even ₹1 Cr+ sums are completely tax-exempt)" },
    { section: "80D", benefit: "If critical illness rider is added, additional deduction of up to ₹25,000 (₹50,000 for senior citizens), potentially saving ₹7,800-15,600 more in taxes" }
  ],
  howToBuy: [
  ...
  commonMistakes: [
    { mistake: "Underinsuring", risk: "A ₹25L cover won't help if your family needs ₹1Cr - 67% of Indian families with life insurance are still underinsured by at least 50%" },
  ...
  claimProcess: [
    ...
    "Document Verification – Insurer checks medical records & disclosures (non-disclosure investigations save insurers ₹450+ crores annually in India)",
    "Payout Processed – IRDAI mandates settlement within 30 days or insurer must pay 2% higher interest than bank rates on the claim amount",
    "Tax-Free Benefit – Entire amount is exempt under Sec 10(10D) regardless of sum assured (even ₹5 Cr+ payouts face zero tax liability)"
  ],
  addOnRiders: [
    ...
    { rider: "Waiver of Premium", benefit: "Future premiums waived if you're disabled or critically ill, saving ₹2-10 lakhs over policy term for an extra 10-12% premium" },
  ...
  expertTips: [
    "Buy before age 35 for lowest premium - each year's delay adds approximately 8-12% to your lifetime costs (₹30-year-old pays ~₹12,000/year while 40-year-old pays ~₹25,000/year for same ₹1Cr cover)",
  ...
  suggestedCompanies: [
    { insurer: "LIC", claimRatio: "98.7%", rating: 4, onlineEase: "Moderate (agent-based mostly, premiums ~8-12% higher than online)" },
    { insurer: "HDFC Life", claimRatio: "98.0%", rating: 5, onlineEase: "Excellent (entirely paperless process, claim settlement in 5-7 days)" },
    { insurer: "Max Life", claimRatio: "99.5%", rating: 4, onlineEase: "Good (offers 10% premium discount for completely online applications)" },
    { insurer: "Tata AIA", claimRatio: "99.0%", rating: 4, onlineEase: "Excellent (fastest growing with median claim settlement of just 3 days)" },
    { insurer: "ICICI Prudential", claimRatio: "97.9%", rating: 4, onlineEase: "Good (auto-indexation feature increases cover by 5-10% annually at no extra cost)" },
    { insurer: "Bajaj Allianz", claimRatio: "96.5%", rating: 3, onlineEase: "Moderate (lowest premium among major insurers, averaging 8-15% less)" }
  ]
};
...
export const healthInsurance: InsuranceDetail = {
  ...
  taxBenefits: [
    { section: "80D", benefit: "Self & family: Up to ₹25,000 deduction" },
    { section: "80D", benefit: "Parents (senior citizens): Additional ₹50,000 deduction" },
    { section: "80D", benefit: "Preventive health checkups: Up to ₹5,000 included in above limits" }
  ],
  howToBuy: [
    ...
    "Check IRDAI Ratings: Claim settlement ratio, grievance resolution"
  ],
  types: [
  ...
  expertTips: [
    "Buy at least ₹10L coverage in metro cities (₹5L elsewhere) due to medical inflation",
  ...
  suggestedCompanies: [
    { insurer: "Star Health", claimRatio: "94.6%", rating: 5, onlineEase: "Excellent" },
    { insurer: "HDFC ERGO", claimRatio: "92.8%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.5%", rating: 4, onlineEase: "Excellent" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 4, onlineEase: "Excellent" },
    { insurer: "Bajaj Allianz", claimRatio: "91.5%", rating: 3, onlineEase: "Good" },
...
export const criticalIllness: InsuranceDetail = {
  ...
  keyPoints: [
    ...
    { 
      ...
      content: "Freedom to choose treatments including experimental options, with average advanced cancer treatments costing ₹12-25 lakh—often exceeding standard health insurance limits by 2-3x",
      importance: "Important",
      icon: "🏥"
    },
    { 
      title: "Financial Independence", 
      content: "Lump sum helps maintain lifestyle during illness, with payout amounts typically set at 5-10x annual income to address average treatment costs of ₹10-20 lakh plus recovery expenses",
      importance: "Recommended",
      icon: "💼"
    },
    { 
  ...
  taxBenefits: [
    { section: "80D", benefit: "Premium deduction up to ₹25,000 (₹50,000 for senior citizens)" },
    { section: "10(10D)", benefit: "Claim amount received is tax-free" }
  ],
  howToBuy: [
    ...
    "Compare Premium vs Coverage: Higher sum insured often has better value per rupee",
  ...
  commonMistakes: [
    ...
    { mistake: "Insufficient coverage", risk: "Treatment + recovery income loss can exceed ₹20-30L for serious conditions" },
  ...
  suggestedCompanies: [
    { insurer: "HDFC ERGO", claimRatio: "92.5%", rating: 5, onlineEase: "Excellent" },
    { insurer: "ICICI Lombard", claimRatio: "91.8%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Max Life Insurance", claimRatio: "94.0%", rating: 4, onlineEase: "Good" },
    { insurer: "Bajaj Allianz", claimRatio: "89.5%", rating: 3, onlineEase: "Moderate" },
    { insurer: "Tata AIA", claimRatio: "95.2%", rating: 5, onlineEase: "Excellent" },
    { insurer: "SBI Life", claimRatio: "90.8%", rating: 4, onlineEase: "Good" }
  ]
};
...
export const motorInsurance: InsuranceDetail = {
  ...
  detailedDescription: "Motor insurance provides financial protection against physical damage to vehicles and liability that could arise from vehicle accidents. It is mandatory by law in India to have at least third-party motor insurance.",
  features: [
  ...
  keyPoints: [
    { 
      ...
      content: "Third-party insurance is mandatory under Motor Vehicles Act. Non-compliance penalties include ₹2,000 fine for first offense and ₹4,000 for subsequent offenses, along with potential imprisonment and license suspension for 3 months.",
      importance: "Critical",
      icon: "⚖️"
    },
    { 
      title: "Financial Protection", 
      content: "Guards against repair/replacement costs after accidents. With average car repair costs ranging from ₹25,000-₹1.5 lakh after minor to moderate accidents, comprehensive insurance costs just 2-3% of vehicle value annually for protection against these expenses.",
      importance: "Important",
      icon: "🚗"
    },
    { 
      title: "Third-Party Liability", 
      content: "Protects against injury/property damage claims by others. Third-party liability in India is now unlimited for personal injuries and death, while property damage coverage is capped at ₹7.5 lakhs - making this coverage absolutely essential.",
      importance: "Recommended",
      icon: "🛡️"
    },
    { 
      title: "NCB Savings", 
      content: "No Claim Bonus provides significant premium discounts. Each claim-free year provides 20% discount in year 1, reaching up to 50% by year 5, which translates to ₹2,500-₹15,000 annual savings on premium for vehicles valued at ₹5-10 lakhs.",
      importance: "Advisable",
      icon: "💰"
    }
  ],
  taxBenefits: [
    { section: "80D", benefit: "No direct tax benefit for personal motor insurance" },
    { section: "Business Vehicle", benefit: "Premiums deductible as business expense for commercial vehicles" }
  ],
  howToBuy: [
  ...
  expertTips: [
    ...
    "Install anti-theft devices for premium discounts (ARAI-approved)",
  ...
  suggestedCompanies: [
    { insurer: "ICICI Lombard", claimRatio: "95.2%", rating: 5, onlineEase: "Excellent" },
    { insurer: "HDFC ERGO", claimRatio: "93.8%", rating: 4, onlineEase: "Excellent" },
    { insurer: "Bajaj Allianz", claimRatio: "92.5%", rating: 4, onlineEase: "Very Good" },
    { insurer: "TATA AIG", claimRatio: "94.3%", rating: 4, onlineEase: "Good" },
    { insurer: "Acko", claimRatio: "91.5%", rating: 4, onlineEase: "Excellent (Digital-only)" },
    { insurer: "Go Digit", claimRatio: "92.7%", rating: 4, onlineEase: "Excellent (Digital-focused)" }
  ]
};
...
export const homeInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Coverage for your home's physical structure against major damages. With average rebuilding costs in India ranging from ₹1,500-4,500 per sq. ft. (₹15-45 lakh for a 1,000 sq. ft. apartment), insurance provides full replacement value at premiums of just ₹3,000-8,000 annually for a ₹50 lakh structure.",
      importance: "Critical",
      icon: "🏠"
    },
    { 
      title: "Natural Disaster Coverage", 
      content: "Financial protection against catastrophic events beyond your control. With increasing climate-related incidents causing average damages of ₹5-20 lakhs, comprehensive insurance covers fire (₹8-15 lakh average claim), flood (₹3-12 lakh average claim), and earthquake damage (₹10-30 lakh average claim).",
      importance: "Important",
      icon: "🔥"
    },
    { 
      title: "Household Contents Security", 
      content: "Protection for valuable possessions inside your home. With average Indian households owning ₹5-15 lakh in contents (furniture, electronics, appliances), insurance typically costs just ₹1,500-4,000 annually to protect against theft (₹2-5 lakh average claim) and accidental damage (₹50,000-3 lakh average claim).",
      importance: "Recommended",
      icon: "💰"
    },
    { 
      title: "Liability Coverage", 
      content: "Protection against third-party claims for injuries on your property. With average liability claims of ₹3-10 lakh and legal expenses of ₹50,000-2 lakh per incident, most policies include ₹5-15 lakh liability coverage as standard, potentially saving from significant financial and legal stress.",
      importance: "Advisable",
      icon: "⚖️"
    }
  ],
  taxBenefits: [
    { section: "Income Tax Act", benefit: "No specific deduction for home insurance premiums" },
  ...
  suggestedCompanies: [
    { insurer: "Bajaj Allianz", claimRatio: "93.2%", rating: 4, onlineEase: "Good" },
    { insurer: "ICICI Lombard", claimRatio: "94.1%", rating: 4, onlineEase: "Excellent" },
    { insurer: "HDFC ERGO", claimRatio: "92.8%", rating: 4, onlineEase: "Very Good" },
    { insurer: "TATA AIG", claimRatio: "91.5%", rating: 4, onlineEase: "Good" },
...
export const wholeLifeInsurance: InsuranceDetail = {
  ...
  taxBenefits: [
    { section: "80C", benefit: "Premiums up to ₹1.5L/year deductible from taxable income" },
    { section: "10(10D)", benefit: "Death benefit fully tax-free for nominee" },
    { section: "10(10D)", benefit: "Maturity proceeds tax-free if conditions are met" }
  ],
  howToBuy: [
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Purchased ₹1Cr whole life plan for business succession planning, ensuring seamless ownership transfer and liquidity for business partners" 
    },
    { 
      name: "Sunita, 35 – Parent of a special needs child", 
      scenario: "Secured lifetime care through ₹50L whole life policy, creating guaranteed corpus regardless of when she passes away" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    { insurer: "LIC", claimRatio: "98.5%", rating: 4, onlineEase: "Moderate" },
    { insurer: "SBI Life", claimRatio: "95.7%", rating: 4, onlineEase: "Good" },
    { insurer: "HDFC Life", claimRatio: "97.8%", rating: 5, onlineEase: "Excellent" },
    { insurer: "Max Life", claimRatio: "96.3%", rating: 4, onlineEase: "Good" },
    { insurer: "Tata AIA", claimRatio: "97.2%", rating: 4, onlineEase: "Very Good" }
  ]
};
...
export const ulipInsurance: InsuranceDetail = {
  ...
  taxBenefits: [
    { section: "80C", benefit: "Premium deduction up to ₹1.5L annually" },
    { section: "10(10D)", benefit: "Tax-free maturity amount if conditions met" },
    { section: "10(10D)", benefit: "Tax-free death benefit for nominee" }
  ],
  howToBuy: [
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Invests ₹2L annually in aggressive ULIP, accumulated ₹43L over 15 years (vs ₹30L premium paid)" 
    },
    { 
      name: "Meera, 28 – Marketing Manager", 
      scenario: "Started ₹1.5L annual ULIP mainly for tax saving, continued disciplined investment for child's education" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    ...
    { insurer: "Bajaj Allianz", claimRatio: "95.3%", rating: 4, onlineEase: "Good" },
    { insurer: "SBI Life", claimRatio: "94.7%", rating: 4, onlineEase: "Good" },
    { insurer: "Max Life", claimRatio: "96.8%", rating: 4, onlineEase: "Very Good" }
  ]
};
...
export const endowmentInsurance: InsuranceDetail = {
  ...
  bestFor: [
    ...
    "Tax-conscious individuals needing Section 80C benefits",
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "₹50,000 annual premium for 20-year endowment, created ₹20L corpus for daughter's higher education" 
    },
    { 
  ...
  suggestedCompanies: [
    { insurer: "LIC", claimRatio: "98.5%", rating: 4, onlineEase: "Moderate" },
    { insurer: "SBI Life", claimRatio: "95.6%", rating: 4, onlineEase: "Good" },
    { insurer: "HDFC Life", claimRatio: "97.2%", rating: 5, onlineEase: "Very Good" },
    { insurer: "Max Life", claimRatio: "96.1%", rating: 4, onlineEase: "Good" },
    { insurer: "Bajaj Allianz", claimRatio: "94.8%", rating: 3, onlineEase: "Moderate" }
  ]
};
...
export const moneyBackInsurance: InsuranceDetail = {
  ...
  taxBenefits: [
    { section: "80C", benefit: "Premium deduction up to ₹1.5L annually" },
    { section: "10(10D)", benefit: "Tax-free survival benefit and maturity amount" },
    { section: "10(10D)", benefit: "Tax-free death benefit for nominee" }
  ],
  howToBuy: [
  ...
  suggestedCompanies: [
    ...
    { insurer: "Bajaj Allianz", claimRatio: "94.2%", rating: 3, onlineEase: "Moderate" },
    { insurer: "HDFC Life", claimRatio: "97.3%", rating: 5, onlineEase: "Very Good" }
  ]
};
...
export const returnPremiumInsurance: InsuranceDetail = {
  ...
  taxBenefits: [
    { section: "80C", benefit: "Premium deduction up to ₹1.5L annually" },
    { section: "10(10D)", benefit: "Tax-free return of premium at maturity" },
    { section: "10(10D)", benefit: "Tax-free death benefit for nominee" }
  ],
  howToBuy: [
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Chose TROP despite higher premium as he values guaranteed return; pays ₹25,000 annually for ₹1Cr cover" 
    },
    { 
  ...
  suggestedCompanies: [
    { insurer: "HDFC Life", claimRatio: "97.8%", rating: 5, onlineEase: "Excellent" },
    { insurer: "ICICI Prudential", claimRatio: "96.5%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Max Life", claimRatio: "97.1%", rating: 4, onlineEase: "Good" },
    { insurer: "Tata AIA", claimRatio: "98.0%", rating: 5, onlineEase: "Excellent" },
    { insurer: "Bajaj Allianz", claimRatio: "95.3%", rating: 3, onlineEase: "Good" }
  ]
};
...
export const childEducationInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Secures funds for education despite parental absence. With undergraduate education costs in India ranging ₹3-20 lakhs and professional degrees costing ₹10-80 lakhs, education plans provide critical financial safety. Premium waiver ensures full benefits continue even if parent dies, with average savings of ₹15-25 lakhs over the policy term.",
      importance: "Critical",
      icon: "🎓"
    },
    { 
      title: "Education Inflation Hedge", 
      content: "Counteracts rising education costs through long-term investment. With education inflation at 10-12% annually (double general inflation), a 4-year degree costing ₹20 lakhs today will cost ₹42 lakhs in 8 years. Education plans with equity exposure of 25-30% aim to provide growth matching or approaching this inflation rate.",
      importance: "Important",
      icon: "📈"
    },
    { 
    ...
    { 
      ...
      content: "Maximizes education corpus through tax advantages. Premiums qualify for Section 80C deductions (saving ₹15,000-46,800 annually depending on tax bracket), while maturity benefits remain tax-free under Section 10(10D), providing 15-25% more effective return compared to taxable alternatives.",
      importance: "Advisable",
      icon: "💼"
    }
  ],
  taxBenefits: [
    { section: "80C", benefit: "Premium deduction up to ₹1.5L annually" },
    { section: "10(10D)", benefit: "Tax-free maturity and periodic payouts" },
    { section: "10(10D)", benefit: "Tax-free death benefit" }
  ],
  howToBuy: [
  ...
  suggestedCompanies: [
    ...
    { insurer: "ICICI Prudential", claimRatio: "96.5%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Max Life", claimRatio: "97.1%", rating: 4, onlineEase: "Good" },
    { insurer: "Bajaj Allianz", claimRatio: "94.8%", rating: 3, onlineEase: "Good" }
  ]
};
...
export const pensionInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Provides predictable lifetime income when employment earnings cease. With the average retirement lasting 18-22 years and requiring 70-80% of pre-retirement income (₹50,000-80,000 monthly for middle-income households), pension plans ensure monthly annuities of ₹25,000-40,000 on a ₹50 lakh corpus, preventing the 68% of unprepared Indians from facing financial hardship.",
      importance: "Critical",
      icon: "👴"
    },
    { 
    ...
    { 
      ...
      content: "Maximizes post-tax retirement income through strategic distributions. Pension plans offer 33% tax-free commutation at retirement (₹16.5 lakhs on a ₹50 lakh corpus), with ₹50,000 annual pension income exemption under Section 87A, and EEE (Exempt-Exempt-Exempt) status on NPS investments up to ₹2 lakhs annually, providing 25-30% higher post-tax returns than taxable investments.",
      importance: "Advisable",
      icon: "💼"
    }
  ],
  taxBenefits: [
    { section: "80CCC", benefit: "Premium deduction up to ₹1.5L (part of overall 80C limit)" },
  ...
  realLifeScenarios: [
    ...
    { 
      ...
      scenario: "Used ₹50L corpus to purchase immediate annuity yielding ₹30,000 monthly for lifetime" 
    }
  ],
  claimProcess: [
  ...
  expertTips: [
    ...
    "Diversify retirement planning across pension plans, PPF, mutual funds",
  ...
  suggestedCompanies: [
    { insurer: "LIC", claimRatio: "99.0%", rating: 4, onlineEase: "Moderate" },
    { insurer: "HDFC Life", claimRatio: "98.0%", rating: 5, onlineEase: "Excellent" },
    { insurer: "SBI Life", claimRatio: "97.2%", rating: 4, onlineEase: "Good" },
    { insurer: "ICICI Prudential", claimRatio: "96.8%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Max Life", claimRatio: "97.5%", rating: 4, onlineEase: "Good" }
  ]
};
...
export const seniorLifeInsurance: InsuranceDetail = {
  ...
  features: [
    ...
    "Limited Coverage: Lower sum assured options (typically ₹5L to ₹25L)",
  ...
  keyPoints: [
    ...
    { 
      title: "Debt Coverage", 
      content: "Ensures outstanding loans don't burden family, with coverage options from ₹5L to ₹25L, sufficient for average senior debt of ₹3.8L in urban India",
      importance: "Recommended",
      icon: "📝"
    },
    { 
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Purchased ₹10L policy with simplified underwriting to cover outstanding home loan" 
    },
    { 
      name: "Sudha, 70 – With diabetes history", 
      scenario: "Got guaranteed acceptance policy with ₹5L coverage for final expenses despite health condition" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    { insurer: "LIC", claimRatio: "98.5%", rating: 4, onlineEase: "Moderate" },
    { insurer: "SBI Life", claimRatio: "95.6%", rating: 4, onlineEase: "Good" },
    { insurer: "Max Life", claimRatio: "96.2%", rating: 4, onlineEase: "Good" },
    { insurer: "HDFC Life", claimRatio: "97.3%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Bajaj Allianz", claimRatio: "94.5%", rating: 3, onlineEase: "Moderate" }
  ]
};
...
export const nriLifeInsurance: InsuranceDetail = {
  ...
  description: "Life insurance for Non-Resident Indians with special compliance features.",
  detailedDescription: "NRI life insurance policies are specifically designed for Indian citizens living abroad. These plans address the unique requirements and compliance needs of NRIs while providing life coverage and investment options that align with their global financial planning.",
  features: [
  ...
  keyPoints: [
    { 
      title: "Indian Family Protection", 
      content: "Financial security for dependents living in India with coverage up to 20x annual income (typically ₹1-5 crore), providing 8-10 years of income replacement for beneficiaries",
      importance: "Critical",
      icon: "🏠"
    },
    { 
      title: "Estate Planning", 
      content: "Wealth transfer to Indian beneficiaries with tax efficiency, avoiding 15-40% inheritance taxes in many foreign jurisdictions through proper DTAA utilization",
      importance: "Important",
      icon: "📜"
    },
    { 
      title: "Rupee-Based Investment", 
      content: "Hedge against currency fluctuation for future Indian expenses with returns of 5-8% in rupee terms, potentially adding 1-2% effective returns when rupee depreciates against foreign currencies",
      importance: "Recommended",
      icon: "₹"
    },
    { 
  ...
  taxBenefits: [
    ...
    { section: "10(10D)", benefit: "Tax-free death benefit for nominee in India" },
  ...
  howToBuy: [
    ...
    "Understand Tax Implications: Both in India and country of residence",
    "Nominee Considerations: Indian vs non-Indian nominee documentation differences"
  ],
  types: [
    { name: "NRI Term Insurance", description: "Pure protection for family in India" },
    { name: "NRI ULIP", description: "Investment-linked insurance with various fund options" },
    { name: "NRI Endowment", description: "Savings and insurance combination for future Indian expenses" },
    { name: "NRI Pension Plan", description: "Retirement corpus building for eventual return to India" }
  ],
  bestFor: [
    "NRIs with financial dependents in India",
    "Those planning to return to India eventually",
    "NRIs with assets and liabilities in India requiring protection",
    "Those wanting to create rupee-denominated corpus for future Indian expenses",
    "NRIs seeking tax-efficient wealth transfer to Indian beneficiaries"
  ],
  commonMistakes: [
    ...
    { mistake: "Misunderstanding tax implications", risk: "Different treatment in India vs country of residence" }
  ],
  realLifeScenarios: [
    { 
      name: "Rahul, 35 – IT Professional in USA", 
      scenario: "Purchased ₹2Cr term plan to protect home loan and family in India while working abroad" 
    },
    { 
      name: "Anita, 42 – Business Consultant in Dubai", 
      scenario: "Selected NRI ULIP as part of retirement planning for eventual return to India at age 55" 
    }
  ],
  claimProcess: [
  ...
  addOnRiders: [
    ...
    { rider: "Income Benefit", benefit: "Regular payouts to family in India in case of policyholder's death" }
  ],
  expertTips: [
    "Complete medical tests during India visits if possible for convenience",
    ...
    "Review policy when planning permanent return to India for possible restructuring"
  ],
  suggestedCompanies: [
    { insurer: "HDFC Life", claimRatio: "97.8%", rating: 5, onlineEase: "Excellent" },
    { insurer: "Max Life", claimRatio: "97.1%", rating: 4, onlineEase: "Very Good" },
    { insurer: "ICICI Prudential", claimRatio: "96.5%", rating: 4, onlineEase: "Excellent" },
    { insurer: "Bajaj Allianz", claimRatio: "95.2%", rating: 3, onlineEase: "Good" },
    { insurer: "LIC", claimRatio: "98.6%", rating: 4, onlineEase: "Moderate" }
  ]
};
...
export const familyFloaterInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Complete healthcare coverage for all members, with recommended coverage of ₹15-20 lakh providing adequate protection for 95% of hospitalization scenarios for a family of four",
      importance: "Critical",
      icon: "👨‍👩‍👧‍👦"
    },
    { 
  ...
  taxBenefits: [
    { section: "80D", benefit: "Up to ₹25,000 deduction for family (self, spouse, children)" },
    { section: "80D", benefit: "Additional ₹25,000 for parents (₹50,000 if senior citizens)" },
    { section: "80D", benefit: "Preventive health checkup benefit included in above limits" }
  ],
  howToBuy: [
    "Family Size Assessment: Number of members to be covered",
    "Age Consideration: Oldest member determines base premium",
    "Sum Insured Calculation: Factor in metropolitan hospital costs (min ₹5-10L recommended)",
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Couple (35, 33) with two children (8, 5) - ₹10L family floater costs approximately ₹18,000 annually" 
    },
    { 
  ...
  suggestedCompanies: [
    ...
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.5%", rating: 4, onlineEase: "Excellent" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 4, onlineEase: "Excellent" },
    { insurer: "Care Health", claimRatio: "93.7%", rating: 4, onlineEase: "Very Good" }
  ]
};
...
export const topupInsurance: InsuranceDetail = {
  ...
  features: [
    "High Sum Insured: Large coverage amount (typically ₹10L to ₹1Cr)",
  ...
  keyPoints: [
    { 
      ...
      content: "Safety net for major illnesses with expensive treatments, providing coverage for high-cost procedures (₹10-30 lakh) that might exceed base policy limits like organ transplants (₹20-30 lakh) or advanced cancer treatments",
      importance: "Critical",
      icon: "🛡️"
    },
    { 
      title: "Value for Money", 
      content: "Get ₹50L+ coverage at 20-30% cost of regular policy (typically ₹3,000-8,000 annually for ₹50 lakh coverage versus ₹15,000-25,000 for equivalent standard policy)",
      importance: "Important",
      icon: "💰"
    },
    { 
  ...
  taxBenefits: [
    { section: "80D", benefit: "Premium eligible for deduction within overall health insurance limits" },
    { section: "80D", benefit: "Up to ₹25,000 for self/family (₹50,000 for senior citizens)" },
    { section: "80D", benefit: "Combined with base health policy for maximum tax advantage" }
  ],
  howToBuy: [
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Has ₹5L employer coverage + ₹50L super top-up with ₹5L deductible; cardiac treatment costing ₹18L fully covered" 
    },
    { 
      name: "Patel Family", 
      scenario: "Multiple hospitalizations totaling ₹9L in a year; ₹5L covered by base policy and remaining ₹4L by super top-up" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    { insurer: "HDFC ERGO", claimRatio: "92.8%", rating: 5, onlineEase: "Excellent" },
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.5%", rating: 4, onlineEase: "Very Good" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 5, onlineEase: "Excellent" },
    { insurer: "Star Health", claimRatio: "94.6%", rating: 4, onlineEase: "Good" },
    { insurer: "Care Health", claimRatio: "93.7%", rating: 4, onlineEase: "Very Good" }
  ]
};
...
export const accidentInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Financial security for family if breadwinner suffers serious accident. With accidental deaths claiming 4.2 lakh lives annually in India and causing 5+ million serious injuries, insurance provides 100% sum assured (recommended 10-20x annual income or ₹50 lakhs-1 crore) at premiums of just ₹6,000-12,000 annually, compared to life insurance rates 3-5x higher.",
      importance: "Critical",
      icon: "⚠️"
    },
    { 
      title: "Temporary Disability Income Replacement", 
      content: "Salary continuation during accident recovery periods. With average accident recovery requiring 4-16 weeks and causing income loss of ₹50,000-4 lakhs, weekly benefit payouts of ₹10,000-25,000 maintain 60-80% of income during temporary disability when most families exhaust savings within 47 days of income interruption.",
      importance: "Important",
      icon: "💸"
    },
    { 
      title: "Accident-Related Medical Expense Coverage", 
      content: "Protection against high hospitalization costs. With average accident-related hospital stays costing ₹80,000-3.5 lakhs (50% higher than illness-related admissions), insurance covers these expenses beyond health insurance limits, with dedicated sub-limits of ₹1-5 lakhs that don't deplete regular health coverage.",
      importance: "Recommended",
      icon: "🏥"
    },
    { 
  ...
  taxBenefits: [
    { section: "80D", benefit: "Premium deduction within overall health insurance limits" },
    { section: "10(10D)", benefit: "Tax-free death benefit for nominee" }
  ],
  howToBuy: [
  ...
  realLifeScenarios: [
    ...
    { 
      ...
      scenario: "Serious car accident caused permanent disability, received ₹50L lump sum plus monthly income benefit" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 5, onlineEase: "Excellent" },
    { insurer: "HDFC ERGO", claimRatio: "92.6%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 4, onlineEase: "Good" },
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 4, onlineEase: "Good" },
...
export const maternityInsurance: InsuranceDetail = {
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Purchased family floater with maternity 2 years before planning baby, saved ₹1.2L on delivery expenses" 
    },
    { 
      name: "Meera – Complex Pregnancy", 
      scenario: "High-risk pregnancy required extended hospitalization; insurance covered ₹3.5L expenses" 
    }
  ],
  claimProcess: [
  ...
  expertTips: [
    ...
    "Choose family floater with adequate sum insured (min ₹10L in metro cities)",
  ...
  suggestedCompanies: [
    { insurer: "Star Health", claimRatio: "94.5%", rating: 5, onlineEase: "Excellent" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.8%", rating: 4, onlineEase: "Good" },
    { insurer: "Care Health", claimRatio: "93.2%", rating: 4, onlineEase: "Very Good" },
...
export const seniorHealthInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    ...
    { 
      ...
      content: "Focuses on treatments commonly needed by seniors like joint replacements (₹3-5 lakh), cataract surgery (₹50,000-1.5 lakh) and cardiac treatments (₹3-7 lakh) with shorter waiting periods (1-2 years vs 3-4 years)",
      importance: "Recommended",
      icon: "👴"
    },
    { 
      title: "Fixed-Budget Planning", 
      content: "Predictable healthcare costs through premium payments of ₹15,000-40,000 annually (depending on age and coverage) versus unpredictable out-of-pocket expenses that can reach ₹5-10 lakh for serious conditions",
      importance: "Advisable",
      icon: "📊"
    }
  ],
  taxBenefits: [
    { section: "80D", benefit: "Enhanced deduction up to ₹50,000 for senior citizens" },
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Purchased ₹10L floater plan, helped cover husband's bypass surgery costing ₹5.5L with minimum out-of-pocket expense" 
    },
    { 
      name: "Mr. Krishnan, 70 – With diabetes and hypertension", 
      scenario: "Senior-specific plan covered his condition after 1-year waiting period, saved ₹3L on subsequent treatment" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    { insurer: "Star Health", claimRatio: "94.6%", rating: 5, onlineEase: "Good" },
    { insurer: "HDFC ERGO", claimRatio: "92.5%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.2%", rating: 4, onlineEase: "Good" },
    { insurer: "Care Health", claimRatio: "93.5%", rating: 5, onlineEase: "Very Good" },
...
export const opdWellnessInsurance: InsuranceDetail = {
  ...
  taxBenefits: [
    { section: "80D", benefit: "Premium deduction within overall health insurance limits" },
    { section: "80D", benefit: "Preventive health check-up deduction up to ₹5,000" }
  ],
  howToBuy: [
  ...
  suggestedCompanies: [
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 5, onlineEase: "Excellent" },
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.5%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Aditya Birla Health", claimRatio: "89.8%", rating: 4, onlineEase: "Excellent" },
    { insurer: "Care Health", claimRatio: "93.2%", rating: 4, onlineEase: "Good" },
...
export const ayushInsurance: InsuranceDetail = {
  ...
  detailedDescription: "AYUSH coverage provides health insurance benefits for alternative medicine treatments including Ayurveda, Yoga, Unani, Siddha, and Homeopathy. This allows policyholders to access traditional Indian systems of medicine with insurance support, offering a holistic approach to healthcare.",
  features: [
  ...
  suggestedCompanies: [
    { insurer: "Star Health", claimRatio: "94.5%", rating: 5, onlineEase: "Very Good" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Good" },
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.8%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Care Health", claimRatio: "93.2%", rating: 4, onlineEase: "Good" },
...
export const groupMediclaimInsurance: InsuranceDetail = {
  ...
  taxBenefits: [
    { section: "80D", benefit: "Premium paid by employee eligible for tax deduction" },
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "5L base coverage per employee + family, with option to buy additional 10L top-up at subsidized rates" 
    },
    { 
  ...
  suggestedCompanies: [
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 5, onlineEase: "Excellent" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 5, onlineEase: "Very Good" },
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 4, onlineEase: "Good" },
    { insurer: "Star Health", claimRatio: "94.5%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.8%", rating: 4, onlineEase: "Good" }
  ]
};
...
export const individualHealthInsurance: InsuranceDetail = {
  ...
  taxBenefits: [
    { section: "80D", benefit: "Premium deduction up to ₹25,000 (₹50,000 for senior citizens)" },
    { section: "80D", benefit: "Additional ₹5,000 for preventive health check-up" }
  ],
  howToBuy: [
    "Health Assessment: Consider age, existing conditions, lifestyle factors",
    "Coverage Calculation: Minimum 5-10L sum insured recommended",
  ...
  commonMistakes: [
    { mistake: "Inadequate coverage", risk: "Urban hospital bills can easily exceed ₹5L for serious conditions" },
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "5L individual policy with restoration benefit; appendectomy plus complications fully covered despite 3.8L bill" 
    },
    { 
      name: "Priya, 35 – Entrepreneur", 
      scenario: "10L comprehensive coverage; hospitalization for dengue fever with no out-of-pocket expenses" 
    }
  ],
  claimProcess: [
...
export const homeStructureInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Financial security against physical damage to your home. The average reconstruction cost in India is ₹1,500-2,500 per sq. ft, meaning a 1,000 sq. ft home would need ₹15-25 lakh coverage minimum.",
      importance: "Critical",
      icon: "🏠"
    },
    { 
      title: "Mortgage Requirement", 
      content: "Often mandatory for homeowners with housing loans. Banks require coverage equal to at least 100-120% of the outstanding loan amount to secure their lending - typically adds just ₹3,000-5,000 annually to a ₹50 lakh home loan.",
      importance: "Important",
      icon: "🏦"
    },
    { 
    ...
    { 
      ...
      content: "Provides financial buffer against natural calamities. In flood-prone areas, water damage repairs average ₹2-3 lakh for structural damage, while fire restoration can cost ₹5,000-8,000 per sq. ft depending on damage severity.",
      importance: "Advisable",
      icon: "🌊"
    }
  ],
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Home severely damaged by monsoon flooding; received ₹18L for structural repairs and temporary accommodation" 
    },
    { 
      name: "Reddy Family, Hyderabad", 
      scenario: "Kitchen fire caused ₹4.5L damage; insurance covered full reconstruction and smoke damage remediation" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 5, onlineEase: "Excellent" },
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 4, onlineEase: "Very Good" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 4, onlineEase: "Excellent" },
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 4, onlineEase: "Good" },
    { insurer: "New India Assurance", claimRatio: "89.6%", rating: 3, onlineEase: "Moderate" }
  ]
};
...
export const homeContentsInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Protection for valuable items inside your home. The average urban Indian household contains ₹4-8 lakhs worth of electronics, furniture, and appliances, with replacement costs rising 8-10% annually due to inflation.",
      importance: "Important",
      icon: "📱"
    },
    { 
      title: "Tenant Protection", 
      content: "Essential for renters who don't need structural coverage. At just ₹1,500-3,000 annually for ₹5 lakh coverage, it's 70-80% less expensive than the potential replacement cost of lost belongings.",
      importance: "Critical",
      icon: "🔑"
    },
    { 
      title: "Theft & Burglary Coverage", 
      content: "Financial protection against criminal incidents. Urban areas see an average loss of ₹1.8-3.2 lakhs in home burglaries, while 65% of victims have no contents insurance to recover these losses.",
      importance: "Recommended",
      icon: "🔒"
    },
    { 
      title: "Accidental Damage Protection", 
      content: "Covers unintentional harm to possessions. A typical mid-range TV replacement costs ₹35,000-50,000, while water damage to electronics from plumbing issues averages ₹80,000-1.2 lakhs in repair/replacement expenses.",
      importance: "Advisable",
      icon: "💧"
    }
  ],
  ...
  realLifeScenarios: [
    { 
      name: "Kumar Family, Delhi", 
      scenario: "Break-in resulted in stolen electronics worth ₹3.5L; insurance provided full replacement cost" 
    },
    { 
      name: "Mehra Household, Bangalore", 
      scenario: "Water leak damaged furniture and carpets; contents insurance covered ₹1.2L in replacement costs" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    ...
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 5, onlineEase: "Very Good" },
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 4, onlineEase: "Good" },
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 4, onlineEase: "Very Good" },
...
export const gadgetInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Specialized coverage for expensive electronic devices. With premium smartphones costing ₹80,000-1.5 lakhs and laptops ranging from ₹50,000-1.2 lakhs, gadget insurance costs just 8-12% of device value annually to protect your investment.",
      importance: "Important",
      icon: "💻"
    },
    { 
    ...
    { 
      ...
      content: "Coverage for stolen devices, a significant risk in India. With average smartphone theft recovery rates below 15% and urban device theft rising 22% annually, insurance offers the only reliable financial protection against permanent loss.",
      importance: "Advisable",
      icon: "🔒"
    }
  ],
  ...
  realLifeScenarios: [
    ...
    { 
      ...
      scenario: "DSLR camera and lenses stolen during travel; received ₹1.35L for complete replacement" 
    }
  ],
  claimProcess: [
...
export const jewelleryInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Security for high-value emotional and financial investments. The average Indian household owns ₹5-15 lakhs in gold and precious jewelry, with annual appreciation of 8-12% making it both a cultural tradition and significant investment.",
      importance: "Critical",
      icon: "💎"
    },
    { 
      title: "Theft & Burglary Coverage", 
      content: "Protection against targeted jewelry theft. With gold jewelry theft accounting for 65% of home burglary value in India and only 7-9% recovery rates, insurance provides the only reliable financial safety net against this specific risk.",
      importance: "Important",
      icon: "🔒"
    },
    { 
      title: "Global Coverage", 
      content: "Protection while traveling or wearing items outside home. Standard home insurance typically caps jewelry coverage at ₹50,000-1 lakh with no protection outside the residence, while specialized policies offer full global protection for just 1-2% of item value annually.",
      importance: "Recommended",
      icon: "🌎"
    },
    { 
  ...
  realLifeScenarios: [
    { 
      name: "Sharma Family, Delhi", 
      scenario: "Diamond necklace worth ₹8.5L stolen during home burglary; insurance provided full replacement" 
    },
    { 
      name: "Mrs. Patel, Mumbai", 
      scenario: "Lost diamond ring while traveling abroad; specialized jewellery policy covered ₹3.2L claim" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 5, onlineEase: "Very Good" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Excellent" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 4, onlineEase: "Good" },
    { insurer: "New India Assurance", claimRatio: "89.6%", rating: 3, onlineEase: "Moderate" },
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 4, onlineEase: "Very Good" }
  ]
};
...
export const fireInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Financial support to rebuild after devastating fires. The average home fire causes ₹5-15 lakhs in damage, while commercial property fires typically result in ₹25 lakhs-1.5 crore in damages, with only 32% of affected properties having adequate insurance.",
      importance: "Critical",
      icon: "🔥"
    },
    { 
      title: "Comprehensive Protection", 
      content: "Covers both structure and contents against fire perils. Fire insurance costs just 0.25-0.60% of the property value annually, making it one of the most cost-effective protections against catastrophic financial loss that affects over 90,000 properties in India each year.",
      importance: "Important",
      icon: "🏠"
    },
    { 
  ...
  types: [
    ...
    { name: "Consequential Loss Coverage", benefit: "Protects against business income loss after fire" }
  ],
  bestFor: [
  ...
  realLifeScenarios: [
    { 
      name: "Gupta's Electronics Store, Delhi", 
    ...
    { 
      ...
      scenario: "Kitchen fire spread to living room causing ₹8L damage; insurance covered repairs and temporary accommodation" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    { insurer: "New India Assurance", claimRatio: "89.6%", rating: 4, onlineEase: "Moderate" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 5, onlineEase: "Excellent" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 4, onlineEase: "Good" },
...
export const petInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Ability to afford the best treatment without financial constraints. The average pet surgery costs ₹20,000-80,000 in India, while cancer treatment ranges from ₹50,000-2 lakhs - with pet insurance covering 70-90% of these expenses for just ₹300-800 monthly.",
      importance: "Critical",
      icon: "🏥"
    },
    { 
    ...
    { 
      ...
      content: "Protection for hereditary and congenital conditions. Purebred dogs have 60% higher likelihood of developing breed-specific conditions (like hip dysplasia at ₹40,000-1 lakh treatment cost), making insurance 3-4x more valuable for these pets.",
      importance: "Recommended",
      icon: "🐕"
    },
    { 
  ...
  taxBenefits: [
    { section: "Income Tax", benefit: "No tax benefits for personal pet insurance in India" },
  ...
  suggestedCompanies: [
    ...
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 4, onlineEase: "Good" },
    { insurer: "PetPlan India", claimRatio: "93.5%", rating: 4, onlineEase: "Very Good" }
  ]
};
...
export const internationalTravelInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Protection against high international healthcare costs. With overseas hospitalization costing ₹3-8 lakhs per day in countries like USA and Europe, and medical evacuation averaging ₹25-40 lakhs, insurance provides coverage at just ₹40-60 per day for trips under 30 days.",
      importance: "Critical",
      icon: "🏥"
    },
    { 
      title: "Travel Investment", 
      content: "Safeguard against financial loss from trip cancellations. The average international trip costs ₹1.5-3 lakhs per person, with typical non-refundable deposits of 30-50%. Travel insurance costs just 4-7% of total trip cost while covering up to 100% of prepaid expenses.",
      importance: "Important",
      icon: "💰"
    },
    { 
      title: "Schengen Visa Requirement", 
      content: "Mandatory for entry into many countries including Schengen nations. Policies must provide minimum €30,000 (₹27 lakhs) medical coverage for Schengen visas, with adequate coverage typically costing ₹800-1,500 for a 7-day trip depending on age and destination.",
      importance: "Recommended",
      icon: "🛂"
    },
    { 
      title: "Emergency Assistance", 
      content: "24/7 global support system for emergencies in foreign countries. With 65% of Indian travelers experiencing at least one travel problem abroad and language barriers affecting 80% of emergency situations, round-the-clock assistance through dedicated helplines saves on average ₹10,000-20,000 in local coordination costs.",
      importance: "Advisable",
      icon: "🌍"
    }
  ],
  ...
  commonMistakes: [
    { mistake: "Inadequate medical coverage", risk: "International treatment can cost lakhs per day" },
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Father hospitalized with appendicitis in New York; insurance covered ₹12L medical bills and extended stay expenses" 
    },
    { 
  ...
  suggestedCompanies: [
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 5, onlineEase: "Excellent" },
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 5, onlineEase: "Very Good" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Excellent" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 4, onlineEase: "Very Good" },
...
export const domesticTravelInsurance: InsuranceDetail = {
  ...
  types: [
    ...
    { name: "Road Trip Coverage", description: "For bus and personal vehicle travel within India" },
  ...
  bestFor: [
    ...
    "Families on vacation within India",
  ...
  realLifeScenarios: [
    ...
    { 
      name: "Rahul, Business Trip to Mumbai", 
  ...
  suggestedCompanies: [
    ...
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 4, onlineEase: "Very Good" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 5, onlineEase: "Excellent" },
    { insurer: "Go Digit", claimRatio: "93.5%", rating: 4, onlineEase: "Excellent" },
    { insurer: "Acko", claimRatio: "92.3%", rating: 3, onlineEase: "Very Good" }
  ]
};
...
export const studentTravelInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Protection against high international healthcare costs. With average hospitalization in the US costing $2,000-5,000 (₹1.5-4 lakhs) per day and up to $100,000 (₹75 lakhs) for major surgeries, student policies provide ₹30-50 lakh coverage for just ₹40,000-70,000 annually.",
      importance: "Critical",
      icon: "🏥"
    },
    { 
      title: "Education Investment Security", 
      content: "Protection against financial loss from interrupted studies. The average 4-year international degree costs ₹80 lakhs to ₹2 crores, with non-refundable tuition losses averaging ₹12-15 lakhs per semester if studies are interrupted - insurance covers up to 100% of these costs.",
      importance: "Important",
      icon: "🎓"
    },
    { 
      title: "Sponsor Protection", 
      content: "Continued education funding if financial sponsor is incapacitated. With 78% of Indian students abroad dependent on family funding, sponsor protection ensures the remaining tuition (averaging ₹40-60 lakhs) is covered if the primary financial supporter faces death or disability.",
      importance: "Recommended",
      icon: "👨‍👩‍👧‍👦"
    },
    { 
  ...
  expertTips: [
    "Purchase policy before leaving India to ensure immediate coverage on arrival",
...
export const seniorTravelInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Specialized protection for age-related health risks while traveling. With seniors 3.4x more likely to require hospitalization abroad and average medical treatment costing ₹4-12 lakhs for 65+ travelers, senior policies provide ₹25-75 lakh coverage specifically designed for age-related conditions.",
      importance: "Critical",
      icon: "🏥"
    },
    { 
      title: "Pre-existing Condition Coverage", 
      content: "Protection despite common age-related health issues. While standard policies exclude pre-existing conditions, senior plans cover stabilized conditions like hypertension, diabetes, and arthritis that affect 68% of travelers aged 60+, reducing potential out-of-pocket expenses by ₹3-15 lakhs.",
      importance: "Important",
      icon: "❤️"
    },
    { 
      title: "Emergency Evacuation", 
      content: "Priority medical transport for seniors facing health crises abroad. Medical evacuations for elderly patients cost ₹8-20 lakhs on average and occur 2.5x more frequently for senior travelers, especially from cruise ships where 43% of serious medical incidents involve passengers aged 65+.",
      importance: "Recommended",
      icon: "🚁"
    },
    { 
      title: "Trip Cancellation Protection", 
      content: "Coverage for age-related trip interruptions. Seniors have a 28% higher trip cancellation rate due to personal or companion health issues, with average non-refundable expenses of ₹1.2-3 lakhs per international trip, and senior policies offering 100% reimbursement compared to 70-80% from standard policies.",
      importance: "Advisable",
      icon: "🗓️"
    }
  ],
  ...
  commonMistakes: [
    ...
    { mistake: "Overlooking evacuation coverage", risk: "Medical evacuations can cost ₹50-80L from remote locations" }
  ],
  realLifeScenarios: [
    { 
    ...
    { 
      ...
      scenario: "Trip cancelled due to pre-departure cardiac issue; received ₹1.8L reimbursement for non-refundable bookings" 
    }
  ],
  claimProcess: [
  ...
  expertTips: [
    ...
    "Register with Indian embassy/consulate at destination for additional support"
  ],
  suggestedCompanies: [
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 5, onlineEase: "Very Good" },
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 4, onlineEase: "Good" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Star Health", claimRatio: "94.5%", rating: 3, onlineEase: "Moderate" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 4, onlineEase: "Good" }
  ]
};
...
export const pilgrimageInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Protection for medical emergencies in remote pilgrimage locations. With helicopter evacuations from Kedarnath costing ₹65,000-1.5 lakhs and emergency medical treatment at high altitudes costing 3-4x normal rates, pilgrimage insurance provides essential coverage at just ₹350-700 for 7-15 day journeys.",
      importance: "Critical",
      icon: "⛰️"
    },
    { 
      title: "Emergency Evacuation", 
      content: "Coverage for medical transport from remote sacred sites. For destinations like Kailash Mansarovar where medical evacuations cost ₹2-5 lakhs, and Char Dham routes where helicopter rescues average ₹75,000-1.2 lakhs, specialized pilgrimage insurance costs just 1-2% of potential evacuation expenses.",
      importance: "Important",
      icon: "🚁"
    },
    { 
      title: "Sacred Journey Protection", 
      content: "Financial security during important spiritual travels. With the average pilgrimage cost of ₹25,000-1.5 lakhs depending on destination, and 30% increased medical risk due to physical exertion and altitude, dedicated coverage ensures that 85-90% of unexpected expenses are covered.",
      importance: "Recommended",
      icon: "🙏"
    },
    { 
      title: "Group Coverage Benefits", 
      content: "Enhanced protection for pilgrimage parties traveling together. Group policies for 10+ travelers offer 15-25% premium discounts while providing ₹50,000-2 lakhs per person coverage, with 94% of group pilgrimage organizers now making insurance mandatory due to historical incident data.",
      importance: "Advisable",
      icon: "👥"
    }
  ],
...
export const adventureSportsInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Protection for activities excluded from standard travel policies. With adventure activities carrying 3-7x higher injury risk and standard travel policies excluding most adventure sports, specialized coverage costing ₹550-1,200 for a 7-day trip provides protection against potential medical costs averaging ₹2-10 lakhs.",
      importance: "Critical",
      icon: "🧗‍♀️"
    },
    { 
      title: "Search & Rescue Operations", 
      content: "Financial support for often costly emergency extractions. Rescue operations in Himalayan treks average ₹1.5-4 lakhs, while helicopter evacuations from remote areas cost ₹2.5-7 lakhs. Coverage for these expenses is provided at just 1.5-3% of potential rescue costs, compared to 100% out-of-pocket without insurance.",
      importance: "Important",
      icon: "🚁"
    },
    { 
      title: "Specialized Medical Coverage", 
      content: "Protection for adventure-specific injuries requiring expert treatment. Adventure sports cause unique injuries (altitude sickness, fractures, diving-related conditions) that cost 40-80% more to treat than common illnesses, with average claims of ₹75,000-2.5 lakhs for serious adventure sport injuries.",
      importance: "Recommended",
      icon: "🏥"
    },
    { 
      title: "Equipment Protection", 
      content: "Coverage for expensive specialized gear. With adventure equipment (climbing gear, cameras, skis, scuba equipment) averaging ₹50,000-2 lakhs in value and 3-5% of trips experiencing gear damage or loss, dedicated coverage provides full replacement value compared to standard policy limits of ₹10,000-15,000.",
      importance: "Advisable",
      icon: "⛷️"
    }
  ],
  ...
  commonMistakes: [
    ...
    { mistake: "Insufficient rescue coverage", risk: "Helicopter evacuation from remote areas can cost lakhs" },
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Suffered fracture at 4,200m altitude; insurance covered ₹2.75L for helicopter rescue and treatment" 
    },
    { 
      name: "Neha, River Rafting Enthusiast", 
      scenario: "Rafting accident in Rishikesh caused shoulder injury and lost equipment; received ₹1.25L coverage" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 5, onlineEase: "Very Good" },
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 5, onlineEase: "Excellent" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Very Good" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 4, onlineEase: "Good" },
...
export const cabRideInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Financial protection for injuries sustained during cab rides. With over 15 million daily app-based cab rides in India and accident rates of 1.8 per 100,000 rides, ride insurance provides coverage of up to ₹5 lakhs for accidental death and ₹2 lakhs for permanent disability at virtually no additional cost to passengers.",
      importance: "Critical",
      icon: "🚗"
    },
    { 
      title: "Medical Expense Coverage", 
      content: "Covers hospitalization costs for ride-related injuries. Ride insurance provides up to ₹75,000 for medical expenses with no waiting period compared to regular health insurance. With emergency medical costs averaging ₹25,000-₹1.5 lakhs for cab-related injuries, this protection is provided at a cost of just ₹1-2 per ride.",
      importance: "Important",
      icon: "🏥"
    },
    { 
  ...
  suggestedCompanies: [
    { insurer: "Acko", claimRatio: "92.3%", rating: 5, onlineEase: "Excellent" },
    { insurer: "Digit Insurance", claimRatio: "93.5%", rating: 4, onlineEase: "Very Good" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 4, onlineEase: "Good" },
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 3, onlineEase: "Moderate" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Good" }
  ]
};
...
export const cancerInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Protection against catastrophic cancer treatment expenses. With advanced cancer therapies costing ₹8-25 lakhs for a complete treatment course (surgery, radiation, chemotherapy), and regular health insurance typically capping coverage at ₹5-10 lakhs, cancer-specific insurance provides additional ₹10-50 lakhs as lump sum upon diagnosis.",
      importance: "Critical",
      icon: "💊"
    },
    { 
      title: "Income Replacement", 
      content: "Support during treatment-related income loss. Cancer patients experience an average income reduction of 40-70% during 8-14 months of treatment and recovery, with households losing ₹3-8 lakhs in earnings. Insurance payouts provide essential financial stability during this period.",
      importance: "Important",
      icon: "💼"
    },
    { 
      title: "Treatment Choice Freedom", 
      content: "Flexibility to access advanced or experimental therapies. Immunotherapy and targeted therapies cost ₹1-3 lakhs per month and are often not fully covered by regular health insurance. Cancer-specific payouts allow 82% of patients to access optimal treatments rather than settling for cost-constrained options.",
      importance: "Recommended",
      icon: "🔬"
    },
    { 
      title: "Family Financial Protection", 
      content: "Long-term security against ongoing financial impact. Studies show cancer diagnosis reduces household financial status for 5-7 years, with 42% of families depleting savings and 28% incurring debt. Lump-sum benefits (taxed at 0% under section 10(10D)) provide crucial long-term stability.",
      importance: "Advisable",
      icon: "👨‍👩‍👧‍👦"
    }
  ],
  taxBenefits: [
    { section: "80D", benefit: "Premium deduction within health insurance limit" },
    { section: "10(10D)", benefit: "Tax-free benefit amount if conditions are met" }
  ],
  howToBuy: [
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Diagnosed with Stage 1 colon cancer; received ₹10L lump sum while health insurance covered treatments" 
    },
    { 
      name: "Priya, 38 – Breast Cancer", 
      scenario: "Received ₹25L payout allowing her to seek advanced treatment abroad not covered by regular insurance" 
    }
  ],
  claimProcess: [
...
export const diabetesInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    ...
    { 
      ...
      content: "Covers high-cost complications with no sub-limits. Diabetic/hypertensive complications like kidney disease, retinopathy, or cardiac events cost ₹3-12 lakhs to treat, with 28% of long-term patients developing at least one major complication. Coverage applies without disease-specific sub-limits that standard policies impose.",
      importance: "Recommended",
      icon: "🫀"
    },
    { 
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Hospitalized for diabetic ketoacidosis; insurance covered ₹1.8L treatment with zero waiting period" 
    },
    { 
  ...
  suggestedCompanies: [
    ...
    { insurer: "Aditya Birla Health", claimRatio: "89.8%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.8%", rating: 4, onlineEase: "Good" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 3, onlineEase: "Moderate" }
  ]
};
...
export const ruralInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Comprehensive coverage against natural calamities causing yield loss. With 60% of Indian agriculture being rain-dependent and average crop loss claims of ₹30,000-₹1.25 lakhs per hectare, PMFBY provides coverage at minimal farmer cost (only 1.5-2% of sum insured), with government subsidizing 98% of the premium (national subsidy outlay: ₹16,000 crore annually).",
      importance: "Critical",
      icon: "🌾"
    },
    { 
      title: "Weather Risk Coverage", 
      content: "Financial security against unpredictable climate patterns. Climate volatility causes ₹90,000 crore in annual agricultural losses nationwide, with individual farmer losses averaging ₹20,000-₹85,000 per season. Weather-based coverage offers parametric payouts within 15-30 days of trigger events versus 45-60 days for traditional claims assessment.",
      importance: "Important",
      icon: "🌧️"
    },
    { 
      title: "Livestock Protection", 
      content: "Insurance for valuable farm animals against mortality and disease. With livestock contributing 28% of agricultural GDP and average cattle values of ₹60,000-₹1.2 lakhs per animal, insurance provides 80-90% value coverage at premiums of just 3-4% for cattle and 5-7% for other livestock, with 50% premium subsidy available for small/marginal farmers.",
      importance: "Recommended",
      icon: "🐄"
    },
    { 
      title: "Farm Equipment Security", 
      content: "Protection for costly agricultural machinery investments. With average tractor/equipment costs of ₹5-12 lakhs and repair expenses of ₹50,000-₹2 lakhs for major damage, insurance covers theft, accidents, and breakdown at premium rates of 1.5-2.5% of equipment value, significantly below general motor insurance rates of 3-5%.",
      importance: "Advisable",
      icon: "🚜"
    }
  ],
  taxBenefits: [
    { section: "Income Tax", benefit: "Agricultural income generally tax-exempt in India" },
...
export const loanProtectionInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Complete loan payoff in case of borrower's death or total disability. With average home loan balance of ₹30-75 lakhs and personal/auto loans of ₹5-15 lakhs, insurance provides 100% loan settlement at premiums of just 0.5-1.2% of loan amount annually (₹3,000-9,000 per year for a ₹50 lakh loan), protecting families from inherited debt burden.",
      importance: "Critical",
      icon: "🏠"
    },
    { 
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Diagnosed with cancer; policy cleared remaining ₹35L home loan, family retained ownership" 
    },
    { 
  ...
  suggestedCompanies: [
    ...
    { insurer: "SBI Life", claimRatio: "94.7%", rating: 3, onlineEase: "Good" }
  ]
};
...
export const eventInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Financial safeguard against unavoidable event cancellation. With average wedding costs of ₹15-40 lakhs and corporate events ranging from ₹5-25 lakhs, insurance provides 80-95% cost recovery for cancellations due to covered reasons at premium rates of just 1-3% of total event budget (₹15,000-75,000 for standard coverage).",
      importance: "Critical",
      icon: "❌"
    },
    { 
      title: "Liability & Third-Party Coverage", 
      content: "Protection from expensive damage claims by attendees or venues. Third-party claims average ₹3-15 lakhs for injuries or property damage at events, with potential litigation costs exceeding ₹5 lakhs. Insurance provides ₹50 lakh - 2 crore coverage at premium rates of ₹8,000-25,000, compared to potential financial ruin without coverage.",
      importance: "Important", 
      icon: "⚖️"
    },
    { 
      title: "Weather Disruption Protection", 
      content: "Recovery from weather-forced cancellations or venue changes. Approximately 18% of outdoor events face significant weather disruptions costing ₹2-8 lakhs for venue changes and ₹75,000-3 lakhs for date changes. Insurance covers 75-90% of these costs, with specialized weather coverage adding only 10-15% to base premium while increasing claim approval rates by 35%.",
      importance: "Recommended",
      icon: "🌧️"
    },
    { 
      title: "Vendor Failure Coverage", 
      content: "Protection if key service providers fail to deliver. With 12% of events experiencing vendor defaults and average replacement costs of ₹50,000-2 lakhs for last-minute alternatives (25-40% more expensive than original vendors), insurance covers these unexpected expenses that would otherwise deplete contingency budgets typically set at just 10% of event cost.",
      importance: "Advisable",
      icon: "🍽️"
    }
  ],
  ...
  realLifeScenarios: [
    { 
      name: "Kumar Wedding, Delhi", 
      scenario: "Venue flooded day before ceremony; insurance covered ₹8.5L in rescheduling costs and vendor rebooking fees" 
    },
    { 
      name: "Tech Conference, Bangalore", 
      scenario: "Keynote speaker unable to attend due to emergency; policy covered ₹3.2L in ticket refunds and rearrangement expenses" 
    }
  ],
  claimProcess: [
...
export const legalExpenseInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Access to quality lawyers regardless of personal finances. With average legal fees in India ranging from ₹25,000-1.5 lakhs for basic cases and ₹3-15 lakhs for complex litigation, legal expense insurance provides coverage at just 2-5% of potential costs, making justice accessible to all income levels.",
      importance: "Critical",
      icon: "⚖️"
    },
    { 
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Boundary wall conflict with neighbor; insurance covered ₹1.8L in legal fees through successful resolution" 
    },
    { 
      name: "Mehta Clothing Store", 
      scenario: "Wrongful termination claim by employee; legal expense insurance provided ₹3.5L for defense counsel" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    ...
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 3, onlineEase: "Moderate" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 4, onlineEase: "Good" },
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 3, onlineEase: "Moderate" },
...
export const opdInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    ...
    { 
      ...
      content: "Financial relief for ongoing medication expenses. With 38% of Indian healthcare expenses going toward prescription drugs (averaging ₹12,000-30,000 annually for chronic condition patients), OPD policies provide 60-80% coverage on medications that standard health insurance excludes entirely.",
      importance: "Recommended",
      icon: "💊"
    },
    { 
  ...
  suggestedCompanies: [
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.8%", rating: 5, onlineEase: "Excellent" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Aditya Birla Health", claimRatio: "89.8%", rating: 4, onlineEase: "Excellent" },
    { insurer: "Care Health", claimRatio: "93.2%", rating: 4, onlineEase: "Good" },
    { insurer: "Star Health", claimRatio: "94.5%", rating: 3, onlineEase: "Moderate" }
...
export const cyberInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Coverage for monetary losses from online scams and fraud. With over 2.7 lakh cybercrime incidents reported in India annually and average financial losses of ₹45,000-₹2.5 lakhs per victim, cyber insurance provides reimbursement of up to 85-95% of stolen funds, compared to zero recovery in 78% of uninsured cases.",
      importance: "Critical",
      icon: "💳"
    },
    { 
      title: "Identity Theft Recovery", 
      content: "Professional assistance restoring compromised identity. Recovery from identity theft costs ₹25,000-₹1.2 lakhs and requires 175-250 hours of personal effort. Insurance provides dedicated recovery specialists, credit monitoring worth ₹12,000 annually, and covers legal fees up to ₹3-5 lakhs for severe cases.",
      importance: "Important",
      icon: "🔐"
    },
    { 
      title: "Malware & Ransomware Coverage", 
      content: "Protection against digital extortion and data hijacking. With ransomware demands averaging ₹35,000 for individuals and ₹1.5-10 lakhs for small businesses, insurance covers ransom payments, data recovery costs (₹15,000-75,000), and system restoration expenses that typically exceed ₹50,000 for comprehensive recovery.",
      importance: "Recommended",
      icon: "🦠"
    },
    { 
      title: "Data Breach Assistance", 
      content: "Expert help managing personal information exposure. Insurance provides credit monitoring services (worth ₹12,000 annually), legal notification guidance, and online reputation management assistance valued at ₹25,000-75,000. Data breach incidents affect 13% of Indian internet users annually with recovery costs averaging ₹32,000.",
      importance: "Advisable",
      icon: "🔒"
    }
  ],
  ...
  realLifeScenarios: [
    ...
    { 
      ...
      scenario: "Lost ₹1.2L through sophisticated banking scam; cyber insurance provided full reimbursement and identity protection services" 
    }
  ],
  claimProcess: [
...
export const covidInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    ...
    { 
      ...
      content: "Financial stability during illness and recovery period. With average recovery requiring 14-28 days and causing income loss of ₹30,000-1.2 lakhs for working individuals, Covid policies provide daily cash benefits of ₹1,000-5,000 during recovery period, protecting against the 72% income reduction experienced by self-employed and contractual workers.",
      importance: "Recommended",
      icon: "💰"
    },
    { 
  ...
  realLifeScenarios: [
    ...
    { 
      ...
      scenario: "Hospitalized for 12 days with oxygen support; Covid-specific policy covered ₹3.8L treatment costs beyond regular health insurance limits" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    ...
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Good" },
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.8%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 3, onlineEase: "Good" }
  ]
};
...
export const groupHealthInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    ...
    { 
      title: "Tax Benefits", 
      content: "Provides tax efficiency with 100% tax deduction for employers under Section 80D (up to ₹1.5 lakh annually) and non-taxable perquisite for employees up to ₹25,000 per family member covered",
      importance: "Recommended",
      icon: "📊"
    },
    { 
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Implemented tiered coverage plan with ₹3L, ₹5L, and ₹10L options based on employee grade; reduced attrition by 18%" 
    },
    { 
  ...
  suggestedCompanies: [
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 5, onlineEase: "Excellent" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Star Health", claimRatio: "94.5%", rating: 4, onlineEase: "Good" },
    { insurer: "Niva Bupa (Max Bupa)", claimRatio: "90.8%", rating: 4, onlineEase: "Very Good" },
    { insurer: "Care Health", claimRatio: "93.2%", rating: 3, onlineEase: "Good" }
  ]
};
...
export const shopkeepersInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Secures valuable merchandise against damage, theft, and disasters. With average retail store inventory valued at ₹10-50 lakhs and 70% of small retailers experiencing inventory loss of 2-5% annually (₹20,000-2.5 lakhs), comprehensive coverage at just 0.3-0.5% of inventory value provides critical financial security.",
      importance: "Critical",
      icon: "📦"
    },
    { 
      title: "Business Property Security", 
      content: "Protects physical assets essential for retail operations. Shop fixtures, furniture, and equipment valued at ₹5-20 lakhs for typical businesses are covered against fire, water damage, and vandalism, with claims settling 65-75% of total shop value compared to just 30-40% under general property policies.",
      importance: "Important",
      icon: "🏪"
    },
    { 
      title: "Liability & Legal Protection", 
      content: "Shields against third-party injury claims and legal expenses. With average slip-and-fall claims in retail spaces ranging from ₹50,000-5 lakhs and 22% of small retailers facing at least one liability claim every 5 years, this coverage prevents potential bankruptcy from legal expenses averaging ₹1.2-3 lakhs per incident.",
      importance: "Recommended",
      icon: "⚖️"
    },
    { 
  ...
  realLifeScenarios: [
    { 
      name: "Sharma Electronics, Delhi", 
      scenario: "Short circuit fire damaged inventory worth ₹12L and forced 2-week closure; insurance covered stock replacement and income loss" 
    },
    { 
      name: "Patel Clothing Store, Mumbai", 
      scenario: "Customer slipped and broke arm; liability coverage handled ₹1.5L medical expenses and prevented lawsuit" 
    }
  ],
  claimProcess: [
...
export const marineTransitInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Safeguards valuable goods during transportation across multiple modes. With cargo theft and damage affecting 5-8% of all shipments annually and average claims ranging from ₹2-15 lakhs per incident, marine insurance costing just 0.25-0.75% of cargo value provides comprehensive coverage against damages, theft, accidents, and natural disasters.",
      importance: "Critical",
      icon: "🚢"
    },
    { 
      title: "Supply Chain Continuity", 
      content: "Ensures business operations continue despite transit disruptions. With average supply chain interruptions costing businesses ₹5-20 lakhs per day in lost sales and contractual penalties, insurance covers additional expenses like expedited shipping (averaging ₹75,000-2 lakhs per emergency shipment) to maintain customer commitments.",
      importance: "Important",
      icon: "⛓️"
    },
    { 
    ...
    { 
      ...
      content: "Defines responsibility boundaries between buyers and sellers. With average dispute resolution costs reaching ₹3-7 lakhs plus legal fees of ₹25,000-1 lakh per month, proper insurance with clearly defined risk transfer points (CIF, FOB, etc.) prevents costly litigation in the 22% of international shipments experiencing delivery issues.",
      importance: "Advisable",
      icon: "⚖️"
    }
  ],
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Container of electronics damaged during monsoon port flooding; received ₹35L compensation for salvageable and total losses" 
    },
    { 
      name: "Textile Exports Co.", 
      scenario: "Truck accident damaged fabric shipment; marine transit insurance covered ₹12L for goods and expedited replacement shipping" 
    }
  ],
  claimProcess: [
...
export const directorsInsurance: InsuranceDetail = {
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Investor sued directors for misrepresentation during funding round; D&O covered ₹85L in legal defense and settlement" 
    },
    { 
      name: "Manufacturing Company CFO", 
      scenario: "Regulatory investigation into financial reporting; policy covered ₹30L in legal representation costs" 
    }
  ],
  claimProcess: [
...
export const commercialPropertyInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Safeguards vital physical business investments from multiple risks. With average commercial building values ranging from ₹50 lakhs to ₹20 crores and equipment/inventory worth ₹10-75 lakhs for medium businesses, property insurance costing 0.3-0.7% of asset value annually provides essential protection against total loss scenarios that affect 5-7% of businesses every decade.",
      importance: "Critical",
      icon: "🏢"
    },
    { 
      title: "Disaster Recovery Funding", 
      content: "Provides financial resources to rebuild after catastrophic events. With average fire damage claims ranging from ₹15-85 lakhs in commercial settings and severe water damage averaging ₹7-30 lakhs per incident, insurance ensures business continuity during the 4-8 month average reconstruction period when 40% of uninsured businesses fail permanently.",
      importance: "Important",
      icon: "🔥"
    },
    { 
      title: "Financial Obligation Protection", 
      content: "Fulfills lender requirements and secures business loans. Banks and financial institutions typically require 100-120% property insurance coverage of outstanding mortgage balance as a condition of commercial loans, with minimum coverage limits directly proportional to loan amounts (₹1 crore insurance for ₹75 lakh loan) to protect their collateral investment.",
      importance: "Recommended",
      icon: "🏦"
    },
    { 
      title: "Business Revenue Protection", 
      content: "Maintains income stream during property damage repairs. Business Interruption coverage replaces 70-85% of proven monthly revenue (averaging ₹5-15 lakhs for medium businesses) for 6-12 months during rebuilding, preventing the cash flow crisis that causes 65% of businesses to close permanently within a year of major property damage.",
      importance: "Advisable",
      icon: "💹"
    }
  ],
  ...
  realLifeScenarios: [
    { 
      name: "Tech Office, Bangalore", 
      scenario: "Electrical fire damaged premises and equipment; insurance covered ₹75L rebuilding costs plus ₹25L business interruption" 
    },
    { 
      name: "Manufacturing Plant, Gujarat", 
      scenario: "Flood damaged machinery and inventory; received ₹1.2Cr for repairs and replacement, preventing business closure" 
    }
  ],
  claimProcess: [
    "Immediate Reporting: Notify insurer within 24-48 hours of incident",
  ...
  suggestedCompanies: [
    { insurer: "New India Assurance", claimRatio: "89.6%", rating: 4, onlineEase: "Moderate" },
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 5, onlineEase: "Very Good" },
    { insurer: "HDFC ERGO", claimRatio: "92.7%", rating: 4, onlineEase: "Excellent" },
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 4, onlineEase: "Good" },
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 3, onlineEase: "Good" }
  ]
...
export const businessInterruptionInsurance: InsuranceDetail = {
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Kitchen fire caused 3-month closure; insurance provided ₹35L for lost profits, staff salaries, and rent during repairs" 
    },
    { 
      name: "Manufacturing Business", 
      scenario: "Machinery breakdown halted production; business interruption coverage funded ₹75L in ongoing expenses and expedited equipment shipping" 
    }
  ],
  claimProcess: [
...
export const businessCyberInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Covers extensive costs associated with cyber incidents. With average data breach expenses in India ranging from ₹12-35 lakhs for SMEs and ₹1.5-4.5 crores for large businesses, cyber insurance costing ₹25,000-2 lakhs annually provides critical financial protection that prevents the 60% business closure rate within 6 months of major uninsured breaches.",
      importance: "Critical",
      icon: "🔐"
    },
    { 
      title: "Customer Notification & Monitoring", 
      content: "Funds mandatory communication and identity protection. With per-customer notification and credit monitoring costs averaging ₹1,200-1,800 per affected individual and typical breaches impacting 5,000-50,000 records, this coverage prevents the ₹60 lakhs-9 crores in unbudgeted expenses that would otherwise immediately impact operating capital.",
      importance: "Important",
      icon: "📢"
    },
    { 
      title: "Legal Defense & Liability Coverage", 
      content: "Protects against third-party claims and regulatory penalties. With average cyber-related litigation costing ₹35-75 lakhs in legal defense regardless of outcome, and DPDP Act/IT Act penalties potentially reaching 2-4% of global turnover, this coverage shields against the financial devastation affecting 23% of breached companies.",
      importance: "Recommended",
      icon: "⚖️"
    },
    { 
      title: "Business Continuity Support", 
      content: "Maintains operations during and after cyber incidents. With ransomware and systems attacks causing average downtime of 9-21 days and costing ₹40,000-3 lakhs per day in lost revenue and recovery expenses, this component provides immediate incident response and digital forensics resources that reduce business interruption duration by 40-60%.",
      importance: "Advisable",
      icon: "🔄"
    }
  ],
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Customer data breach affected 50,000 accounts; insurance covered ₹80L in forensics, notification, and credit monitoring" 
    },
    { 
      name: "Software Company", 
      scenario: "Ransomware attack disrupted services; cyber policy covered ₹65L in ransom payment, system restoration, and lost income" 
    }
  ],
  claimProcess: [
  ...
  suggestedCompanies: [
    ...
    { insurer: "ICICI Lombard", claimRatio: "93.2%", rating: 5, onlineEase: "Very Good" },
    { insurer: "Bajaj Allianz", claimRatio: "91.8%", rating: 4, onlineEase: "Good" },
    { insurer: "TATA AIG", claimRatio: "90.5%", rating: 4, onlineEase: "Excellent" },
...
export const professionalIndemnityInsurance: InsuranceDetail = {
  ...
  keyPoints: [
    { 
      ...
      content: "Shields against claims of negligence, errors or omissions in professional services. With average professional negligence claims in India ranging from ₹15-75 lakhs across sectors (₹35-90 lakhs for medical professionals, ₹25-80 lakhs for architects, ₹20-60 lakhs for CAs), PI insurance priced at 0.5-2% of annual revenue provides essential protection that 92% of professionals wish they had after facing a claim.",
      importance: "Critical",
      icon: "🛡️"
    },
    { 
      title: "Legal Defense Coverage", 
      content: "Covers substantial litigation costs regardless of fault. With professional liability defense averaging ₹8-15 lakhs for even unfounded claims and potentially exceeding ₹25-40 lakhs for complex cases, this coverage prevents the devastating financial impact that causes 47% of uninsured professionals to liquidate personal assets during prolonged litigation.",
      importance: "Important",
      icon: "⚖️"
    },
    { 
  ...
  realLifeScenarios: [
    { 
      ...
      scenario: "Client alleged tax filing errors resulting in penalties of ₹18 lakhs plus interest. The CA's ₹50 lakh PI policy covered ₹12 lakhs in legal defense costs and ₹22 lakhs in settlement, protecting the CA's personal assets from liquidation. Policy premium: ₹65,000/year based on ₹75 lakh practice revenue.",
      importance: "Critical",
      icon: "📊"
    },
    { 
      name: "Architect Firm", 
      scenario: "Design flaw claim required structural modifications to a commercial building. PI coverage of ₹1 crore paid ₹35 lakhs for remediation and ₹18 lakhs in legal expenses, preventing bankruptcy of the 7-person firm. Without coverage, each partner would have faced personal liability averaging ₹7.5 lakhs. Annual premium: ₹1.2 lakhs.",
      importance: "Important",
      icon: "🏗️"
    },
    {
      name: "IT Consultant",
      scenario: "Software implementation failure caused client data loss and 3 days of business disruption. PI insurance covered ₹15 lakhs in data recovery costs, ₹8 lakhs in client business interruption claims, and ₹5 lakhs in legal fees. The consultant maintained client relationship and secured three new projects within 12 months. Premium cost: ₹40,000/year.",
      importance: "Recommended",
      icon: "💻"
    },
    {
      name: "Medical Specialist",
      scenario: "Patient alleged delayed diagnosis led to complications requiring additional treatment. Despite proper protocols being followed, litigation lasted 14 months. PI insurance covered ₹28 lakhs in legal defense proving standard of care was met, plus ₹15 lakhs in settlement to avoid protracted court proceedings. Annual premium: ₹1.8 lakhs based on specialty and practice size.",
      importance: "Important",
      icon: "🏥"
    }
  ],
