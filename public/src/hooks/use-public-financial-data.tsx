...
// Custom hook to fetch active SIPs
export function useSIPs() {
  return useQuery<SIP[], Error>({
...
export function useMarketNews() {
  return useQuery<MarketNews[], Error>({
...
export function calculateFinancialHealth(
  ...
  // Higher score for regular SIPs and consistent transaction history
