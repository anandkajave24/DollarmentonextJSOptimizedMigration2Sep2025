        ...
        <TabsContent value="trending">
          ...
          <Card>
            <CardHeader className="bg-gray-200 dark:bg-gray-800 border-b">
              ...
              <CardDescription>
                Current activity in the RupeeSmart community
              </CardDescription>
            </CardHeader>
            <CardContent>
...
const samplePosts: Post[] = [
  {
    ...
    title: "Best tax-saving investments for FY 2025-26?",
...
const sampleDiscussions: Discussion[] = [
  ...
  },
  {
    ...
    preview: "I've been investing for 8 years now. Current allocation: 60% Indian equities (40% large-cap, 20% mid/small), 15% US equities, 15% debt, 5% gold, 5% REITs. Monthly SIP of ₹50,000. Goals include retirement at 50 and children's education.",
