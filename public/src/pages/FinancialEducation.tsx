...
export default function FinancialEducation() {
  const [courses] = useState<CourseType[]>([
    ...
    },
    {
      ...
      description: "A comprehensive guide to understanding and investing in mutual funds.",
      duration: "4 weeks",
      level: "Intermediate",
      image: "pie_chart",
      category: "investing"
  ...
  const [articles] = useState<ArticleType[]>([
    ...
    },
    {
      ...
      snippet: "Understand what debt mutual funds are and how they can fit into your investment strategy.",
      ...
      <Card className="mt-6">
        <CardContent className="p-4">
          ...
          <div className="space-y-3">
            <div>
              <h4 className="text-sm font-medium">SIP (Systematic Investment Plan)</h4>
              <p className="text-xs text-gray-500">A method of investing a fixed amount regularly in mutual funds.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Tax-saving mutual funds that primarily invest in equities.</p>
            </div>
