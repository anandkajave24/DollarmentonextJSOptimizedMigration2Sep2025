  ...
  return (
    <div className="px-4 py-6">
      <SEO 
        ...
        canonical="https://rupeesmart.com/financial-management"
      />
      <div className="mb-6">
...
const features: FeatureCard[] = [
  ...
  },
  {
    ...
    description: "Securely connect your bank accounts through India's Account Aggregator framework for real-time transaction data.",
