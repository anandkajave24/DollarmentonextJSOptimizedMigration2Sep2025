              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div className="p-3 border border-gray-200 rounded-md">
                    <h4 className="font-medium text-sm mb-2">Start from Template</h4>
                    <Select 
                      onValueChange={(value) => {
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="family-portfolio">Family Financial Plan</SelectItem>
                        <SelectItem value="homeowner-portfolio">Homeowner's Plan</SelectItem>
                        <SelectItem value="diversified-portfolio">Diversified Portfolio</SelectItem>
                        <SelectItem value="aggressive-growth">Aggressive Growth Strategy</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
