  ...
  return (
    <div className="px-4 py-6">
      <SEO 
        ...
        keywords="indian investments, investment comparison, market data, market trends, investment tools, investment analysis, market behavior, future projection"
        canonical="https://rupeesmart.com/investment-market-menu"
      />
      <div className="mb-6">
