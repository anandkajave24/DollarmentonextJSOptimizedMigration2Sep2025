...
const crypticClues = [
  ...
  },
  {
    ...
    explanation: "The Indian Rupee comes in paper notes and flows in the economy."
  },
  {
    id: 8,
  ...
  {
    id: 11,
    clue: "I'm not a tree, but I grow your wealth",
    answer: "SIP",
    options: ["SIP", "FD", "PPF", "NSC"],
    explanation: "SIP (Systematic Investment Plan) helps grow wealth through regular investments."
  },
  {
    id: 12,
    clue: "You lock me for 5 years, I give you benefits in return",
    answer: "TAX SAVER FD",
    options: ["TAX SAVER FD", "PPF", "NSC", "ELSS"],
    explanation: "Tax Saver Fixed Deposits have a 5-year lock-in period with tax benefits."
  },
  {
    id: 13,
    clue: "I'm a popular tax-saving instrument but don't have a blade",
    answer: "ELSS",
    options: ["ELSS", "PPF", "NSC", "ULIP"],
  ...
  },
  {
    ...
    answer: "MUTUAL FUND",
    options: ["MUTUAL FUND", "STOCK", "BOND", "FD"],
  ...
  },
  {
    ...
    options: ["SOVEREIGN GOLD BOND", "GOLD ETF", "DIGITAL GOLD", "GOLD FUND"],
  ...
  // Financial Wisdom
  {
    ...
    options: ["FINANCIAL DISCIPLINE", "SAVINGS", "INVESTMENT", "BUDGET"],
  ...
  },
  {
    ...
    answer: "FINANCIAL FREEDOM",
    options: ["FINANCIAL FREEDOM", "MONEY", "SAVINGS", "INCOME"],
  ...
  // Modern Finance
  {
    ...
    options: ["DIGITAL WALLET", "CREDIT CARD", "DEBIT CARD", "UPI"],
  ...
  },
  {
    ...
    clue: "I'm gold on paper — no locker needed",
    answer: "GOLD BOND",
    options: ["GOLD BOND", "GOLD ETF", "PHYSICAL GOLD", "GOLD COIN"],
  ...
  },
  {
    ...
    options: ["FURNITURE EMI", "HOME LOAN", "CAR LOAN", "PERSONAL LOAN"],
  ...
  },
  {
    ...
    options: ["PEER PRESSURE", "SOCIAL MEDIA", "FRIENDS", "FAMILY"],
  ...
  },
  {
    ...
    options: ["STANDING INSTRUCTION", "AUTO-PAY", "SIP", "EMI"],
  ...
  {
    id: 70,
    clue: "SIP is to mutual funds as ______ is to insurance",
    answer: "PREMIUM",
    options: ["PREMIUM", "POLICY", "CLAIM", "BENEFIT"],
    explanation: "SIP provides regular investments to mutual funds like premiums to insurance."
  },
  {
    id: 71,
  ...
  },
  {
    ...
    answer: "MUTUAL FUND",
    options: ["MUTUAL FUND", "STOCK", "BOND", "INVESTMENT"],
  ...
  {
    id: 78,
    clue: "India's central bank: ______",
    answer: "RBI",
    options: ["RBI", "SBI", "SEBI", "IRDA"],
    explanation: "Reserve Bank of India (RBI) is the central banking institution."
  },
  {
    id: 79,
  ...
  },
  {
    ...
    answer: "MICROFINANCE",
    options: ["MICROFINANCE", "PERSONAL LOAN", "CREDIT CARD", "EMI"],
  ...
  },
  {
    ...
    answer: "SENSEX CRASH",
    options: ["SENSEX CRASH", "MARKET NEWS", "STOCK FALL", "VOLATILITY"],
  ...
  },
  {
    ...
    answer: "FD RETURN",
    options: ["FD RETURN", "BOND RETURN", "PPF RETURN", "NSC RETURN"],
    explanation: "Fixed deposit returns are guaranteed but may lose value to inflation over time."
  },
  {
    id: 85,
    clue: "I'm gifted on Diwali but rarely encashed",
    answer: "GIFT CARD",
    options: ["GIFT CARD", "GOLD COIN", "VOUCHER", "CASH"],
    explanation: "Gift cards are popular Diwali gifts but often remain unused or forgotten."
  },
  {
    id: 86,
    clue: "I'm your income's enemy and government's friend",
    answer: "GST",
    options: ["GST", "INCOME TAX", "SERVICE TAX", "VAT"],
    explanation: "GST reduces take-home income but provides revenue for government services."
  },
  {
    id: 87,
    ...
    explanation: "Equity mutual funds historically beat inflation over long investment periods."
  },
  {
    id: 88,
  ...
  },
  {
    ...
    answer: "SUKANYA SAMRIDDHI",
    options: ["SUKANYA SAMRIDDHI", "CHILD PLAN", "EDUCATION LOAN", "PPF"],
    explanation: "Sukanya Samriddhi Yojana saves taxes while securing girl child's future."
  },
  {
    id: 92,
    clue: "I'm high on interest, low on risk, and post office's pride",
    answer: "KVP",
    options: ["KVP", "PPF", "NSC", "SCSS"],
    explanation: "Kisan Vikas Patra offers good interest with low risk, popular at post offices."
  },
  {
    id: 93,
    clue: "My address is permanent, my value isn't",
    answer: "PAN CARD",
    options: ["PAN CARD", "AADHAAR", "PASSPORT", "LICENSE"],
    explanation: "PAN card has permanent number but its utility value changes with tax laws."
  },
  {
    id: 94,
    clue: "I tell your financial story in 3 digits",
    answer: "CREDIT SCORE",
    options: ["CREDIT SCORE", "CIBIL SCORE", "RISK SCORE", "RATING"],
  ...
  },
  {
    ...
    answer: "STOCK MARKET",
    options: ["STOCK MARKET", "MUTUAL FUND", "EQUITY", "SHARE"],
  ...
  },
  {
    ...
    answer: "ITR",
    options: ["ITR", "TAX FORM", "REFUND", "RETURN"],
    explanation: "Income Tax Return (ITR) is single form that can generate multiple year refunds."
  },
  {
    id: 98,
    clue: "You swipe for Rs.999, but pay Rs.1,199",
    answer: "GST",
    options: ["GST", "HIDDEN CHARGES", "PROCESSING FEE", "TAX"],
    explanation: "GST adds to the base price, making final payment higher than displayed amount."
  },
  {
    id: 99,
  ...
  },
  {
    ...
    options: ["BUDGET PLANNER", "EXPENSE TRACKER", "FINANCIAL APP", "MONEY MANAGER"],
...
const initializeGameGrid = () => {
  ...
  // Major life decision points - Based on real Indian financial scenarios with branching paths
  const lifeScenarios = [
    {
      col: 0, row: 4, ageRange: '22-24', stage: 'First Job Reality',
      scenario: "🎓 You're 22, engineering graduate from tier-2 college. Real job market scenario.",
      question: "Your first job offer - what's your financial strategy?",
      options: [
        { text: "TCS/Infosys ₹3.5L package - Start SIP ₹3K", impact: { income: 29000, savings: 3000, stability: 30 }, points: 25, path: 'corporate' },
        { text: "Bangalore startup ₹6L + equity - High expenses", impact: { income: 45000, expenses: 35000, growth: 40 }, points: 30, path: 'startup' },
        { text: "Family business ₹25K - Low expenses", impact: { income: 25000, expenses: 15000, family: 20 }, points: 15, path: 'family' }
      ]
    },
    // Corporate Path Scenarios
    {
      col: 1, row: 3, ageRange: '25-27', stage: 'Corporate Growth', path: 'corporate',
      scenario: "💼 You're in TCS/Infosys. Regular appraisals, structured growth. Colleagues discussing onsite opportunities.",
      question: "How do you accelerate your corporate career?",
      options: [
        { text: "Focus on onsite - double salary opportunity", impact: { income: 60000, savings: 15000 }, points: 35 },
        { text: "Switch to higher paying company", impact: { income: 20000, risk: 10 }, points: 25 },
    ...
    // Startup Path Scenarios  
    {
      ...
      scenario: "🚀 Startup is growing fast. Series A funding happened. Your equity is worth ₹15L on paper.",
      question: "How do you handle startup volatility?",
      options: [
        { text: "Exercise stock options, diversify portfolio", impact: { investments: 1500000, risk: -20 }, points: 40 },
        { text: "Hold all equity, bet on company growth", impact: { risk: 50, potential: 100 }, points: 35 },
        { text: "Switch to stable company, cash out", impact: { income: 30000, stability: 30 }, points: 25 }
      ]
    },
    // Family Business Path Scenarios
    {
      ...
      options: [
        { text: "Invest ₹5L in digital transformation", impact: { income: 15000, business: 40 }, points: 35 },
        { text: "Expand to new locations", impact: { income: 10000, risk: 25 }, points: 30 },
        { text: "Keep things steady, save money", impact: { savings: 50000, growth: -10 }, points: 20 }
      ]
    },
    {
      col: 1, row: 4, ageRange: '25-27', stage: 'Credit Card Trap',
      scenario: "💳 You got HDFC/ICICI credit card. Friends upgrading lifestyle. EMI culture everywhere.",
      ...
      options: [
        ...
        { text: "Buy iPhone on EMI, manage payments", impact: { debt: 80000, lifestyle: 30, stress: 20 }, points: 15 },
    ...
    },
    {
      ...
      scenario: "📚 IIM calls for ₹25L fee. Friends doing MS in US for ₹40L. Current salary ₹8L.",
      question: "Education investment or continue working?",
      options: [
        { text: "Take education loan, do IIM", impact: { debt: 2500000, income: 120000, prestige: 50 }, points: 35 },
        { text: "Upskill online, switch jobs", impact: { income: 20000, savings: 50000, practical: 40 }, points: 40 },
        { text: "Continue current job, save money", impact: { savings: 100000, growth: -10 }, points: 20 }
      ]
    },
    {
      col: 3, row: 4, ageRange: '31-33', stage: 'Marriage Financial Reality',
      scenario: "💒 Marriage talks begin. Family expects ₹12L wedding. Your savings: ₹5L. Partner earns ₹6L.",
      question: "How do you handle wedding finances?",
      options: [
        { text: "Court marriage + ₹2L reception, invest rest", impact: { expenses: 200000, savings: 300000, family: -20 }, points: 45 },
        { text: "Traditional wedding ₹8L, family contributes ₹3L", impact: { expenses: 500000, family: 30, debt: 0 }, points: 35 },
        { text: "Dream wedding ₹15L, take personal loan", impact: { expenses: 1500000, debt: 1000000, stress: 40 }, points: 10 }
      ]
    },
    {
      col: 4, row: 4, ageRange: '34-36', stage: 'Property vs SIP Dilemma',
      scenario: "🏠 Bangalore 2BHK costs ₹80L. Your savings: ₹20L. Rent: ₹25K. Home loan: ₹60L at 8.5%.",
      question: "The biggest financial decision of your life:",
      options: [
        { text: "Buy house: EMI ₹55K for 20 years", impact: { assets: 8000000, debt: 6000000, emi: 55000 }, points: 25 },
        { text: "Keep renting, SIP ₹40K monthly", impact: { rent: 25000, sip: 40000, flexibility: 50 }, points: 40 },
        { text: "Buy with parents' money, no loan", impact: { assets: 8000000, family: 60, independence: -30 }, points: 30 }
      ]
    },
    {
      col: 5, row: 4, ageRange: '37-39', stage: 'Child Education Planning',
      scenario: "👶 Baby arrives! School fees in Bangalore: ₹2L/year. Engineering costs ₹25L. Medical ₹1Cr.",
      question: "How do you prepare for child's future?",
      options: [
        { text: "Start child SIP ₹20K, cut lifestyle", impact: { childSip: 20000, lifestyle: -20, planning: 60 }, points: 45 },
        { text: "Buy child insurance plans", impact: { insurance: 50000, safety: 40, returns: -10 }, points: 25 },
    ...
    },
    {
      ...
      options: [
        { text: "Continue aggressive SIP, family adjusts", impact: { sip: 60000, family: -20, fire: 40 }, points: 35 },
    ...
    },
    {
      ...
      scenario: "😰 Company downsizing. Your ₹25L package at risk. Portfolio: ₹3Cr. Child in engineering.",
    ...
    },
    {
      ...
      options: [
        { text: "Use emergency fund, maintain SIPs", impact: { emergency: -800000, health: 60, fire: 10 }, points: 40 },
...
const InvestmentPuzzles: React.FC = () => {
  ...
  const [financialStats, setFinancialStats] = useState({
    age: 22,
    netWorth: 0,
    monthlyIncome: 35000, // Realistic starting salary for fresh graduate
    monthlyExpenses: 20000, // Living with parents or PG
    investments: 0,
    debt: 0,
    emergencyFund: 0,
    stress: 10,
  ...
  const handleDecisionChoice = (choice: any) => {
    ...
    // Apply financial impact with Indian market salary progression
    setFinancialStats(prev => {
      ...
      // Update age and apply realistic Indian salary progression
      const ageMap = {
      ...
      // Apply Indian market salary hikes (8-15% annually based on industry)
      if (yearsProgressed > 0) {
        let annualHikeRate = 0.12; // Default 12% for IT sector
        
        // Adjust hike rate based on career path and experience
        if (newStats.monthlyIncome < 50000) {
          annualHikeRate = 0.15; // Higher hikes in early career
        } else if (newStats.monthlyIncome > 150000) {
          annualHikeRate = 0.08; // Slower growth at senior levels
        }
      ...
      // Apply Indian inflation to expenses (6% annually)
      if (yearsProgressed > 0) {
        for (let i = 0; i < yearsProgressed; i++) {
          newStats.monthlyExpenses = Math.round(newStats.monthlyExpenses * 1.06);
        }
      }
      ...
      if (yearlySavings > 0) {
        // Indian equity market returns: 12% annually (long-term average)
        const investmentGrowth = newStats.investments * 0.12 * yearsProgressed;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Master Indian financial markets through interactive learning</p>
              </div>
            </div>
              ...
              >
                <div className="text-center mb-4">
                  ...
                  <div className="bg-green-50 p-3 rounded-lg border border-green-200 text-left">
                    ...
                    <p className="text-xs text-green-700 mb-2">
                      Build a ₹5 Crore portfolio by age 60 so you never have to worry about money again.
                    </p>
                    
                    <h4 className="font-bold text-green-800 mb-1 text-sm">📈 WHAT YOU'LL LEARN:</h4>
                ...
                <div className="grid grid-cols-5 gap-2 mb-3">
                  ...
                  <div className="bg-green-50 p-2 rounded border text-center">
                    ...
                    <div className="font-bold text-green-700 text-sm">₹{(financialStats.netWorth / 100000).toFixed(1)}L</div>
                  </div>
                    ...
                    >
                      ...
                      <div className="p-4 border-b bg-blue-50">
                        ...
                        <div className="text-xs text-blue-700 space-y-1">
                          <div>• <strong>TCS/Infosys:</strong> Safe choice, predictable 10-15% annual hikes, good for learning basics</div>
                          <div>• <strong>Startup:</strong> Higher risk but potential for 50-100% salary jumps if successful</div>
                          <div>• <strong>Family Business:</strong> Lower income but minimal expenses, good work-life balance</div>
                          <div>• <strong>SIP Impact:</strong> ₹3K monthly SIP for 38 years = ₹2.5 Crore (assuming 12% returns)</div>
                        </div>
                      </div>
                      ...
                      {Object.keys(playerChoices).length === 0 ? (
                          ...
                          <button
                            onClick={() => {
                              const firstScenario = {
                                ...
                                question: "Your first job offer - what's your financial strategy?",
                                options: [
                                  { text: "TCS/Infosys ₹3.5L package - Start SIP ₹3K", impact: { income: 29000, savings: 3000, stability: 30 }, points: 25 },
                                  { text: "Bangalore startup ₹6L + equity - High expenses", impact: { income: 45000, expenses: 35000, growth: 40 }, points: 30 },
                                  { text: "Family business ₹25K - Low expenses", impact: { income: 25000, expenses: 15000, family: 20 }, points: 15 }
                                ]
                              };
                        ...
                        <>
                          ...
                          <div className="text-sm text-orange-600">
                            Each yellow lightning bolt represents a major life decision that will impact your path to ₹5 Crore!
                          </div>
                        </>
                      )}
                    </div>
                ...
                {journeyCompleted && (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-700 mb-3">
                      Final Net Worth: ₹{(financialStats.netWorth / 100000).toFixed(1)}L | Life Points: {totalLifePoints}
                    </p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { term: "SIP", correct: "Systematic Investment Plan", options: ["Stock Investment Portfolio", "Systematic Investment Plan", "Savings Interest Program"] }
                ].map((match, index) => (
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <select 
                        ...
                        onChange={(e) => {
                          ...
                          e.target.parentElement.parentElement.style.backgroundColor = isCorrect ? '#d4edda' : '#f8d7da';
                        }}
                      >
