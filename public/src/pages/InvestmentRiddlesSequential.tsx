...
const investmentRiddles: Riddle[] = [
  ...
  {
    id: 14,
    question: "I'm the fee charged by mutual funds for managing your investment, expressed as an annual percentage. What am I?",
    options: ["Management Fee", "Expense Ratio", "Load Fee", "Transaction Fee"],
    answer: 1,
    explanation: "The Expense Ratio is the annual fee charged by mutual funds for managing your investment, covering management fees, administrative costs, and other operational expenses.",
    difficulty: "medium",
    category: "mutual-funds",
    completed: false
  },
  ...
  {
    id: 23,
    question: "I'm the section of the Income Tax Act that allows deductions up to ₹1.5 lakhs. What am I?",
    options: ["Section 80C", "Section 80D", "Section 24", "Section 10"],
    answer: 0,
    explanation: "Section 80C of the Income Tax Act allows deductions up to ₹1.5 lakhs for investments in specified instruments like PPF, ELSS, life insurance premiums, etc.",
    difficulty: "easy",
    category: "tax",
    completed: false
  },

  // 💰 GENERAL FINANCE (30+ riddles)
  {
    id: 24,
