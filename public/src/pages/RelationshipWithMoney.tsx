  ...
  return (
    <div className="px-6 py-5 max-w-4xl mx-auto">
      <SEO 
        ...
        canonical="https://rupeesmart.com/relationship-with-money"
      />
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        ...
        <TabsContent value="self-assessment" className="space-y-4">
          ...
          <Card className="overflow-hidden border-b">
            ...
            <CardContent className="p-4 grid grid-cols-1 gap-4">
              <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg relative">
                <div className="absolute inset-0 flex items-center justify-center opacity-10">
                  <span className="material-icons text-6xl">radar</span>
                </div>
                <h4 className="text-center text-sm font-medium text-gray-700 mb-2">Money Profile Dimensions</h4>
                <div className="space-y-2">
                  {Object.entries(questions).map(([key, question]) => (
                    <div key={key} className="flex items-center justify-between text-xs">
                      <span className="text-gray-700">{key.split('_').join(' ').replace(/\b\w/g, l => l.toUpperCase())}</span>
                      <div className="w-24 bg-white dark:bg-gray-700 rounded-full h-2">
                        <div 
                          className="bg-indigo-400 h-2 rounded-full" 
                          style={{ width: `${(responses[key]/5)*100}%` }}
                        ></div>
                      </div>
                    </div>
                  ))}
              ...
              <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                <h4 className="text-center text-sm font-medium text-gray-700 mb-2">Overall Money Mindset Score</h4>
                {(() => {
                  ...
                  return (
                    <>
                      <div className="flex items-center justify-center mb-3">
                        <span className="text-4xl mr-3">{getMoodEmoji(progress)}</span>
                        <div>
                          <div className="text-2xl font-bold text-indigo-700">{Math.round(progress * 100)}%</div>
                          <div className="text-xs text-gray-500">Money Mindset Score</div>
                        </div>
                      </div>
                      <Progress value={progress * 100} className="h-3 bg-indigo-100" />
                      <div className="mt-3 text-center">
                        {progress < 0.4 ? (
                          <p className="text-amber-600 text-sm font-medium">Early stages, but you're on the right path! 🌱</p>
                        ) : progress < 0.7 ? (
                          <p className="text-blue-600 text-sm font-medium">Great progress! Keep building those money habits! 💪</p>
                        ) : (
                          <p className="text-emerald-600 text-sm font-medium">Excellent money mindset! Keep thriving! 🌟</p>
                        )}
                      </div>
                    </>
                  );
        ...
        <TabsContent value="progress-tracker" className="space-y-4">
          <Card className="overflow-hidden">
            <div className="bg-gray-200 dark:bg-gray-800 px-4 py-3 border-b">
              <h3 className="font-medium text-lg flex items-center text-black dark:text-white text-black dark:text-white">
                <span className="material-icons text-blue-500 mr-2">monitoring</span>
                Financial Health Dashboard
              </h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Track your progress and visualize your financial well-being</p>
            </div>
            <CardContent className="p-4">
              <div>
                ...
                <div className="mt-6 p-5 bg-gray-50 dark:bg-gray-700 rounded-xl border">
                  ...
                  <div className="space-y-3">
                    <Progress 
                      value={(health.overallScore / 5) * 100} 
                  ...
                  <div className="mt-5 p-4 bg-white dark:bg-gray-700 rounded-lg border flex">
                    <div className="mr-3 text-center">
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                        health.overallScore < 2.5 ? "bg-red-100 text-red-600" : 
                        health.overallScore < 3.5 ? "bg-amber-100 text-amber-600" : 
                        "bg-emerald-100 text-emerald-600"
                      }`}>
                        <span className="material-icons">
                          {health.overallScore < 2.5 ? "priority_high" : 
                           health.overallScore < 3.5 ? "trending_up" : 
                           "verified"}
                        </span>
                      </div>
                    </div>
                    <div>
                      <h4 className="font-medium mb-1">
                        {health.overallScore < 2.5 ? "Focus Areas Identified" : 
                         health.overallScore < 3.5 ? "Positive Progress" : 
                         "Financial Wellness"}
                      </h4>
                      {health.overallScore < 2.5 ? (
        ...
        <TabsContent value="action-plan" className="space-y-4">
          <Card className="overflow-hidden">
            <div className="bg-gray-200 dark:bg-gray-800 px-4 py-3 border-b">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Customized steps to improve your financial relationship based on your assessment</p>
            </div>
            <CardContent className="p-4">
              <div className="mb-6">
