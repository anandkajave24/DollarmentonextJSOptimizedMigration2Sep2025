  ...
  return (
    <div className="px-4 py-6">
      <SEO 
        ...
        canonical="https://rupeesmart.com/risk-assessment"
      />
                  ...
                  <>
                    <div className="p-4 border rounded-lg">
                      ...
                      <ul className="list-disc pl-5 space-y-1 text-gray-700">
                        ...
                        <li>Debt mutual funds with short to medium duration</li>
                      </ul>
                    </div>
                ...
                {riskProfile.name === "Moderate" && (
                  <>
                    <div className="p-4 border rounded-lg">
                      ...
                      <ul className="list-disc pl-5 space-y-1 text-gray-700">
                        <li>Balanced mutual funds with equity and debt components</li>
                        <li>Mix of large-cap and mid-cap equity funds</li>
                        <li>Regular investment through SIPs to average market fluctuations</li>
                      </ul>
                    </div>
