    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          This helps personalize calculations for non-equity investments taxed as per your income slab.
        </p>
      </div>
      
      {/* Final Calculation Section - Always visible */}
      <Card className="mb-8">
          ...
          {(stcgEntries.length > 0 || ltcgEntries.length > 0) ? (
                  ...
                  <div className="p-4 bg-slate-50 rounded-md">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Tax Rate:</span>
                          <span className="font-medium">{ltcgTaxRate * 100}% (>₹1L)</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground max-w-lg mx-auto mb-4">
                Use the forms below to add your short-term and long-term capital gains and losses.
                Your tax savings calculations will appear here automatically.
              </p>
