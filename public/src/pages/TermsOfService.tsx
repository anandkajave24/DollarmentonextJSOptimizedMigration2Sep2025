...
export default function TermsOfService() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <Helmet>
        <title>Terms of Service | RupeeSmart</title>
      </Helmet>
      ...
      <div className="prose prose-blue max-w-none">
        ...
        <p>
          By accessing or using RupeeSmart's services, website, and mobile application (collectively, the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the Service.
        </p>
        
        <h2 className="text-2xl font-semibold mt-8 mb-4">2. Description of Service</h2>
        <p>
          RupeeSmart is a financial management platform that helps users track expenses, manage budgets, and gain insights into their financial health. The Service may include features such as:
        </p>
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>WhatsApp notifications for financial alerts</li>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">5. SMS and WhatsApp Integration</h2>
        <p>
        ...
        <p>
          If you choose to enable WhatsApp notifications, our Service will send financial alerts, reminders, and updates to your registered WhatsApp number. You can opt out of these notifications at any time through your account settings.
        </p>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>To impersonate or attempt to impersonate RupeeSmart, a company employee, or another user</li>
        </ul>
        ...
        <p>
          The Service may contain links to third-party websites or services that are not owned or controlled by RupeeSmart. We have no control over, and assume no responsibility for, the content, privacy policies, or practices of any third-party websites or services.
        </p>
        ...
        <p>
          In no event shall RupeeSmart, its directors, employees, partners, agents, suppliers, or affiliates be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:
        </p>
        <ul className="list-disc pl-6 mb-4">
        ...
        <p>
          The Service is provided on an "AS IS" and "AS AVAILABLE" basis. RupeeSmart disclaims all warranties of any kind, whether express or implied, including but not limited to the implied warranties of merchantability, fitness for a particular purpose, and non-infringement.
        </p>
        ...
        <p className="mb-8">
          Email: terms@rupeesmart.com<br />
          Address: RupeeSmart Financial Services, 123 Finance Street, Mumbai, India 400001
        </p>
      </div>
    </div>
  );
